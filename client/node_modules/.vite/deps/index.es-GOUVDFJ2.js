...
import "./chunk-R5TPUDDX.js";
import "./chunk-4HTCHAMS.js";
import {
  require_events
...
(function(C, u2) {
  (function() {
    ...
    function cn(h, g2, p2) {
      switch (p2.length) {
        case 0:
          return h.call(g2);
        case 1:
          return h.call(g2, p2[0]);
        case 2:
          return h.call(g2, p2[0], p2[1]);
        case 3:
          return h.call(g2, p2[0], p2[1], p2[2]);
      }
      return h.apply(g2, p2);
    }
    function Vo(h, g2, p2, A) {
      for (var S3 = -1, U3 = h == null ? 0 : h.length; ++S3 < U3; ) {
        var X = h[S3];
        g2(A, X, p2(X), h);
      }
      return A;
    ...
    function mn(h, g2) {
      for (var p2 = -1, A = h == null ? 0 : h.length; ++p2 < A && g2(h[p2], p2, h) !== false; )
        ;
      return h;
    }
    function ko(h, g2) {
      for (var p2 = h == null ? 0 : h.length; p2-- && g2(h[p2], p2, h) !== false; )
        ;
      return h;
    }
    function As(h, g2) {
      for (var p2 = -1, A = h == null ? 0 : h.length; ++p2 < A; )
        if (!g2(h[p2], p2, h))
          return false;
      return true;
    }
    function jn(h, g2) {
      for (var p2 = -1, A = h == null ? 0 : h.length, S3 = 0, U3 = []; ++p2 < A; ) {
        var X = h[p2];
        g2(X, p2, h) && (U3[S3++] = X);
      }
      return U3;
    ...
    function Ee(h, g2) {
      var p2 = h == null ? 0 : h.length;
      return !!p2 && Tt(h, g2, 0) > -1;
    }
    function Dr(h, g2, p2) {
      for (var A = -1, S3 = h == null ? 0 : h.length; ++A < S3; )
        if (p2(g2, h[A]))
          return true;
      return false;
    }
    function G2(h, g2) {
      for (var p2 = -1, A = h == null ? 0 : h.length, S3 = Array(A); ++p2 < A; )
        S3[p2] = g2(h[p2], p2, h);
      return S3;
    }
    function nt(h, g2) {
      for (var p2 = -1, A = g2.length, S3 = h.length; ++p2 < A; )
        h[S3 + p2] = g2[p2];
      return h;
    }
    function Hr(h, g2, p2, A) {
      var S3 = -1, U3 = h == null ? 0 : h.length;
      for (A && U3 && (p2 = h[++S3]); ++S3 < U3; )
        p2 = g2(p2, h[S3], S3, h);
      return p2;
    }
    function jo(h, g2, p2, A) {
    ...
    function Cs(h, g2, p2) {
      var A;
      return p2(h, function(S3, U3, X) {
        if (g2(S3, U3, X))
          return A = U3, false;
      }), A;
    }
    function ye(h, g2, p2, A) {
      for (var S3 = h.length, U3 = p2 + (A ? 1 : -1); A ? U3-- : ++U3 < S3; )
        if (g2(h[U3], U3, h))
          return U3;
      return -1;
    }
    function Tt(h, g2, p2) {
      return g2 === g2 ? gf(h, g2, p2) : ye(h, Is, p2);
    }
    function rf(h, g2, p2, A) {
      for (var S3 = p2 - 1, U3 = h.length; ++S3 < U3; )
        if (A(h[S3], g2))
          return S3;
      return -1;
    }
    ...
    function Es(h, g2, p2, A, S3) {
      return S3(h, function(U3, X, M2) {
        p2 = A ? (A = false, U3) : g2(p2, U3, X, M2);
      }), p2;
    }
    function sf(h, g2) {
      var p2 = h.length;
    ...
    function Wr(h, g2) {
      for (var p2, A = -1, S3 = h.length; ++A < S3; ) {
        var U3 = g2(h[A]);
        U3 !== i && (p2 = p2 === i ? U3 : p2 + U3);
      }
      return p2;
    }
    function Fr(h, g2) {
      for (var p2 = -1, A = Array(h); ++p2 < h; )
        A[p2] = g2(p2);
      return A;
    }
    function uf(h, g2) {
      return G2(g2, function(p2) {
        return [p2, h[p2]];
      });
    }
    function ys(h) {
    ...
    function Ss(h, g2) {
      for (var p2 = -1, A = h.length; ++p2 < A && Tt(g2, h[p2], 0) > -1; )
        ;
      return p2;
    }
    function Os(h, g2) {
      for (var p2 = h.length; p2-- && Tt(g2, h[p2], 0) > -1; )
        ;
      return p2;
    }
    function af(h, g2) {
      for (var p2 = h.length, A = 0; p2--; )
        h[p2] === g2 && ++A;
      return A;
    }
    ...
    function pf(h) {
      for (var g2, p2 = []; !(g2 = h.next()).done; )
        p2.push(g2.value);
      return p2;
    }
    function qr(h) {
      var g2 = -1, p2 = Array(h.size);
      return h.forEach(function(A, S3) {
        p2[++g2] = [S3, A];
      }), p2;
    }
    function Rs(h, g2) {
    ...
    function tt(h, g2) {
      for (var p2 = -1, A = h.length, S3 = 0, U3 = []; ++p2 < A; ) {
        var X = h[p2];
        (X === g2 || X === It) && (h[p2] = It, U3[S3++] = p2);
      }
      return U3;
    }
    function Se(h) {
    ...
    function gf(h, g2, p2) {
      for (var A = p2 - 1, S3 = h.length; ++A < S3; )
        if (h[A] === g2)
          return A;
      return -1;
    }
    ...
    function bs(h) {
      for (var g2 = h.length; g2-- && so.test(h.charAt(g2)); )
        ;
      return g2;
    }
    var _f = Ur(Yo);
    function mf(h) {
      for (var g2 = br.lastIndex = 0; br.test(h); )
        ++g2;
      return g2;
    }
    function wf(h) {
    ...
    var Af = function h(g2) {
      g2 = g2 == null ? k2 : Ht.defaults(k2.Object(), g2, Ht.pick(k2, Bo));
      var p2 = g2.Array, A = g2.Date, S3 = g2.Error, U3 = g2.Function, X = g2.Math, M2 = g2.Object, Br = g2.RegExp, Cf = g2.String, wn = g2.TypeError, Oe = p2.prototype, If = U3.prototype, Nt = M2.prototype, Re = g2["__core-js_shared__"], be = If.toString, F = Nt.hasOwnProperty, xf = 0, Ts = function() {
        var n = /[^.]+$/.exec(Re && Re.keys && Re.keys.IE_PROTO || "");
        return n ? "Symbol(src)_1." + n : "";
      }(), Te = Nt.toString, Ef = be.call(M2), yf = k2._, Sf = Br("^" + be.call(F).replace(xr, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Le = ds ? g2.Buffer : i, et = g2.Symbol, De = g2.Uint8Array, Ls = Le ? Le.allocUnsafe : i, He = Rs(M2.getPrototypeOf, M2), Ds = M2.create, Hs = Nt.propertyIsEnumerable, Ne = Oe.splice, Ns = et ? et.isConcatSpreadable : i, ne = et ? et.iterator : i, pt = et ? et.toStringTag : i, $e = function() {
        try {
          var n = mt(M2, "defineProperty");
          return n({}, "", {}), n;
        } catch {
        }
      }(), Of = g2.clearTimeout !== k2.clearTimeout && g2.clearTimeout, Rf = A && A.now !== k2.Date.now && A.now, bf = g2.setTimeout !== k2.setTimeout && g2.setTimeout, Ue = X.ceil, We = X.floor, Gr = M2.getOwnPropertySymbols, Tf = Le ? Le.isBuffer : i, $s = g2.isFinite, Lf = Oe.join, Df = Rs(M2.keys, M2), Q3 = X.max, nn = X.min, Hf = A.now, Nf = g2.parseInt, Us = X.random, $f = Oe.reverse, zr = mt(g2, "DataView"), te = mt(g2, "Map"), Kr = mt(g2, "Promise"), $t = mt(g2, "Set"), ee = mt(g2, "WeakMap"), re = mt(M2, "create"), Fe = ee && new ee(), Ut = {}, Uf = wt(zr), Wf = wt(te), Ff = wt(Kr), Mf = wt($t), qf = wt(ee), Me = et ? et.prototype : i, ie = Me ? Me.valueOf : i, Ws = Me ? Me.toString : i;
      function a(n) {
        if (Y(n) && !O2(n) && !(n instanceof H)) {
          if (n instanceof Pn)
            return n;
      ...
      a.templateSettings = { escape: ja, evaluate: no, interpolate: Zi, variable: "", imports: { _: a } }, a.prototype = qe.prototype, a.prototype.constructor = a, Pn.prototype = Wt(qe.prototype), Pn.prototype.constructor = Pn;
      function H(n) {
      ...
      function zf() {
        var n = this.__wrapped__.value(), t = this.__dir__, e = O2(n), r = t < 0, s = e ? n.length : 0, o = eh(0, s, this.__views__), f2 = o.start, c = o.end, l = c - f2, v2 = r ? c : f2 - 1, _2 = this.__iteratees__, m2 = _2.length, P2 = 0, I = nn(l, this.__takeCount__);
        if (!e || !r && s == l && I == l)
        ...
        n:
          for (; l-- && P2 < I; ) {
            ...
            for (var b2 = -1, y2 = n[v2]; ++b2 < m2; ) {
              var D2 = _2[b2], N2 = D2.iteratee, dn = D2.type, sn = N2(y2);
              if (dn == $a)
                y2 = sn;
              else if (!sn) {
                if (dn == Bi)
      ...
      function Fs(n, t) {
        var e = O2(n), r = !e && Pt(n), s = !e && !r && at(n), o = !e && !r && !s && Bt(n), f2 = e || r || s || o, c = f2 ? Fr(n.length, Cf) : [], l = c.length;
        for (var v2 in n)
          (t || F.call(n, v2)) && !(f2 && (v2 == "length" || s && (v2 == "offset" || v2 == "parent") || o && (v2 == "buffer" || v2 == "byteLength" || v2 == "byteOffset") || Zn(v2, l))) && c.push(v2);
        return c;
      }
      function Ms(n) {
        var t = n.length;
      ...
      function qs(n, t) {
        return n && Un2(t, V(t), n);
      }
      function vc(n, t) {
        return n && Un2(t, on(t), n);
      }
      function zn(n, t, e) {
        t == "__proto__" && $e ? $e(n, t, { configurable: true, enumerable: true, value: e, writable: true }) : n[t] = e;
      }
      function Zr(n, t) {
        for (var e = -1, r = t.length, s = p2(r), o = n == null; ++e < r; )
          s[e] = o ? i : Si(n, t[e]);
        return s;
      }
      function vt(n, t, e) {
      ...
      function An(n, t, e, r, s, o) {
        ...
        if (I)
          return I;
        o.set(n, f2), sa(n) ? n.forEach(function(y2) {
          f2.add(An(y2, t, e, y2, n, o));
        }) : ra(n) && n.forEach(function(y2, D2) {
          f2.set(D2, An(y2, t, e, D2, n, o));
        });
        var E2 = v2 ? l ? pi : li : l ? on : V, b2 = _2 ? i : E2(n);
        return mn(b2 || n, function(y2, D2) {
          b2 && (D2 = y2, y2 = n[D2]), se(f2, D2, An(y2, t, e, D2, n, o));
        }), f2;
      }
      function _c(n) {
        var t = V(n);
      ...
      function ue(n, t, e, r) {
        var s = -1, o = Ee, f2 = true, c = n.length, l = [], v2 = t.length;
        if (!c)
          return l;
        e && (t = G2(t, hn(e))), r ? (o = Dr, f2 = false) : t.length >= w && (o = jt, f2 = false, t = new gt(t));
        n:
          for (; ++s < c; ) {
      ...
      function en(n) {
        return n == null ? n === i ? Ya : za : pt && pt in M2(n) ? th(n) : dh(n);
      }
      function Qr(n, t) {
        return n > t;
      }
      ...
      function Vr(n, t, e) {
        for (var r = e ? Dr : Ee, s = n[0].length, o = n.length, f2 = o, c = p2(o), l = 1 / 0, v2 = []; f2--; ) {
          var _2 = n[f2];
          f2 && t && (_2 = G2(_2, hn(t))), l = nn(_2.length, l), c[f2] = !e && (t || s >= 120 && _2.length >= 120) ? new gt(f2 && _2) : i;
        }
        _2 = n[0];
        var m2 = -1, P2 = c[0];
        n:
          for (; ++m2 < s && v2.length < l; ) {
            var I = _2[m2], E2 = t ? t(I) : I;
            if (I = e || I !== 0 ? I : 0, !(P2 ? jt(P2, E2) : r(v2, E2, e))) {
              for (f2 = o; --f2; ) {
                var b2 = c[f2];
                if (!(b2 ? jt(b2, E2) : r(n[f2], E2, e)))
                  continue n;
              }
              P2 && P2.push(E2), v2.push(I);
            }
          }
        return v2;
      }
      ...
      function yc(n, t, e, r, s, o) {
        var f2 = O2(n), c = O2(t), l = f2 ? me : tn(n), v2 = c ? me : tn(t);
        l = l == Ot ? qn : l, v2 = v2 == Ot ? qn : v2;
        var _2 = l == qn, m2 = v2 == qn, P2 = l == v2;
        if (P2 && at(n)) {
          if (!at(t))
            return false;
          f2 = true, _2 = false;
        ...
        if (P2 && !_2)
          return o || (o = new Rn()), f2 || Bt(n) ? Su(n, t, e, r, s, o) : jc(n, t, l, e, r, s, o);
        if (!(e & Et)) {
          var I = _2 && F.call(n, "__wrapped__"), E2 = m2 && F.call(t, "__wrapped__");
          if (I || E2) {
            var b2 = I ? n.value() : n, y2 = E2 ? t.value() : t;
            return o || (o = new Rn()), s(b2, y2, e, r, o);
          }
        }
        return P2 ? (o || (o = new Rn()), nh(n, t, e, r, s, o)) : false;
      }
      function Sc(n) {
        return Y(n) && tn(n) == yn;
      }
      function kr(n, t, e, r) {
        ...
        for (; ++s < o; ) {
          ...
          if (f2 && c[2]) {
            ...
            var m2 = new Rn();
            if (r)
              var P2 = r(v2, _2, l, n, t, m2);
            if (!(P2 === i ? oe3(_2, v2, Et | ve, r, m2) : P2))
              return false;
          }
        }
        return true;
      ...
      function Qs(n) {
        return typeof n == "function" ? n : n == null ? fn : typeof n == "object" ? O2(n) ? js(n[0], n[1]) : ks(n) : ma(n);
      }
      function jr(n) {
        if (!he(n))
          return Df(n);
      ...
      function js(n, t) {
        return _i(n) && Tu(t) ? Lu(Wn(n), t) : function(e) {
          var r = Si(e, n);
          return r === i && r === t ? Oi(e, n) : oe3(t, r, Et | ve);
        };
      }
      ...
      function Lc(n, t, e, r, s, o, f2) {
        var c = wi(n, e), l = wi(t, e), v2 = f2.get(l);
        if (v2) {
          Yr(n, e, v2);
          return;
        }
        ...
        if (m2) {
          var P2 = O2(l), I = !P2 && at(l), E2 = !P2 && !I && Bt(l);
          _2 = l, P2 || I || E2 ? O2(c) ? _2 = c : Z(c) ? _2 = un(c) : I ? (m2 = false, _2 = hu(l, true)) : E2 ? (m2 = false, _2 = lu(l, true)) : _2 = [] : pe(l) || Pt(l) ? (_2 = c, Pt(c) ? _2 = oa(c) : (!K(c) || Jn(c)) && (_2 = bu(l))) : m2 = false;
        }
        m2 && (f2.set(l, _2), s(_2, l, r, o, f2), f2.delete(l)), Yr(n, e, _2);
      }
      function nu(n, t) {
        var e = n.length;
        if (e)
      ...
      function Nc(n, t, e, r) {
        for (var s = -1, o = Q3(Ue((t - n) / (e || 1)), 0), f2 = p2(o); o--; )
          f2[r ? o : ++s] = n, n += e;
        return f2;
      }
      function ri(n, t) {
      ...
      function fe(n, t, e, r) {
        ...
        for (var s = -1, o = t.length, f2 = o - 1, c = n; c != null && ++s < o; ) {
          ...
          if (s != f2) {
            var _2 = c[l];
            v2 = r ? r(_2, l, c) : i, v2 === i && (v2 = K(_2) ? _2 : Zn(t[s + 1]) ? [] : {});
          }
          se(c, l, v2), c = c[l];
        }
        return n;
      ...
      function ii(n, t, e, r) {
        ...
        for (var f2 = t !== t, c = t === null, l = pn(t), v2 = t === i; s < o; ) {
          var _2 = We((s + o) / 2), m2 = e(n[_2]), P2 = m2 !== i, I = m2 === null, E2 = m2 === m2, b2 = pn(m2);
          if (f2)
            var y2 = r || E2;
          else
            v2 ? y2 = E2 && (r || P2) : c ? y2 = E2 && P2 && (r || !I) : l ? y2 = E2 && P2 && !I && (r || !b2) : I || b2 ? y2 = false : y2 = r ? m2 <= t : m2 < t;
          y2 ? s = _2 + 1 : o = _2;
        }
        return nn(o, Fa);
      }
      ...
      function it(n, t, e) {
        var r = -1, s = Ee, o = n.length, f2 = true, c = [], l = c;
        if (e)
          f2 = false, s = Dr;
        else if (o >= w) {
          var v2 = t ? null : Vc(n);
      ...
      function du(n, t, e, r) {
        for (var s = -1, o = n.length, f2 = e.length, c = -1, l = t.length, v2 = Q3(o - f2, 0), _2 = p2(l + v2), m2 = !r; ++c < l; )
          _2[c] = t[c];
        for (; ++s < f2; )
          (m2 || s < o) && (_2[e[s]] = n[s]);
        for (; v2--; )
      ...
      function gu(n, t, e, r) {
        for (var s = -1, o = n.length, f2 = -1, c = e.length, l = -1, v2 = t.length, _2 = Q3(o - c, 0), m2 = p2(_2 + v2), P2 = !r; ++s < _2; )
          m2[s] = n[s];
        for (var I = s; ++l < v2; )
          m2[I + l] = t[l];
        for (; ++f2 < c; )
          (P2 || s < o) && (m2[I + e[f2]] = n[s++]);
        return m2;
      }
      function un(n, t) {
        var e = -1, r = n.length;
      ...
      function Ft(n) {
        return L2(function(t, e) {
          ...
          for (o = n.length > 3 && typeof o == "function" ? (s--, o) : i, f2 && rn(e[0], e[1], f2) && (o = s < 3 ? i : o, s = 1), t = M2(t); ++r < s; ) {
            var c = e[r];
            c && n(t, c, r, o);
          }
          return t;
      ...
      function Jc(n, t, e) {
        var r = t & vn, s = ce(n);
        function o() {
          var f2 = this && this !== k2 && this instanceof o ? s : n;
      ...
      function Xc(n, t, e) {
        var r = ce(n);
        function s() {
          for (var o = arguments.length, f2 = p2(o), c = o, l = qt(s); c--; )
            f2[c] = arguments[c];
          var v2 = o < 3 && f2[0] !== l && f2[o - 1] !== l ? [] : tt(f2, l);
          if (o -= v2.length, o < e)
            return Iu(n, t, Xe2, s.placeholder, i, f2, v2, i, i, e - o);
        ...
        return Yn(function(t) {
          ...
          for (n && t.reverse(); r--; ) {
            ...
            if (typeof o != "function")
              throw new wn($2);
            if (s && !f2 && je(o) == "wrapper")
              var f2 = new Pn([], true);
          }
          for (r = f2 ? r : e; ++r < e; ) {
            o = t[r];
            var c = je(o), l = c == "wrapper" ? di(o) : i;
            l && mi(l[0]) && l[1] == (Mn | Dn | Hn | Kt) && !l[4].length && l[9] == 1 ? f2 = f2[je(l[0])].apply(f2, l[3]) : f2 = o.length == 1 && mi(o) ? f2[c]() : f2.thru(o);
          }
          return function() {
            var v2 = arguments, _2 = v2[0];
            if (f2 && v2.length == 1 && O2(_2))
              return f2.plant(_2).value();
            for (var m2 = 0, P2 = e ? t[m2].apply(this, v2) : _2; ++m2 < e; )
              P2 = t[m2].call(this, P2);
            return P2;
          };
        });
      }
      function Xe2(n, t, e, r, s, o, f2, c, l, v2) {
        var _2 = t & Mn, m2 = t & vn, P2 = t & ct, I = t & (Dn | yt), E2 = t & dr, b2 = P2 ? i : ce(n);
        function y2() {
          for (var D2 = arguments.length, N2 = p2(D2), dn = D2; dn--; )
            N2[dn] = arguments[dn];
          if (I)
            var sn = qt(y2), gn = af(N2, sn);
          if (r && (N2 = du(N2, r, s, I)), o && (N2 = gu(N2, o, f2, I)), D2 -= gn, I && D2 < v2) {
            var J = tt(N2, sn);
            return Iu(n, t, Xe2, y2.placeholder, e, N2, J, c, l, v2 - D2);
          }
          var Tn = m2 ? e : this, Qn = P2 ? Tn[n] : n;
          return D2 = N2.length, c ? N2 = gh(N2, c) : E2 && D2 > 1 && N2.reverse(), _2 && l < D2 && (N2.length = l), this && this !== k2 && this instanceof y2 && (Qn = b2 || ce(Qn)), Qn.apply(Tn, N2);
        }
        return y2;
      }
      function Au(n, t) {
      ...
      function ci(n) {
        return Yn(function(t) {
          return t = G2(t, hn(x())), L2(function(e) {
            var r = this;
      ...
      function Qc(n, t, e, r) {
        var s = t & vn, o = ce(n);
        function f2() {
          for (var c = -1, l = arguments.length, v2 = -1, _2 = r.length, m2 = p2(_2 + l), P2 = this && this !== k2 && this instanceof f2 ? o : n; ++v2 < _2; )
            m2[v2] = r[v2];
          for (; l--; )
            m2[v2++] = arguments[++c];
      ...
      function Iu(n, t, e, r, s, o, f2, c, l, v2) {
        var _2 = t & Dn, m2 = _2 ? f2 : i, P2 = _2 ? i : f2, I = _2 ? o : i, E2 = _2 ? i : o;
        t |= _2 ? Hn : St, t &= ~(_2 ? St : Hn), t & qi || (t &= ~(vn | ct));
        var b2 = [n, t, s, I, m2, E2, P2, c, l, v2], y2 = e.apply(i, b2);
        return mi(n) && Nu(y2, b2), y2.placeholder = r, $u(y2, n, t);
      }
      function hi(n) {
        var t = X[n];
        return function(e, r) {
      ...
      var Vc = $t && 1 / Se(new $t([, -0]))[1] == ht ? function(n) {
        return new $t(n);
      } : Di;
      function xu(n) {
        return function(t) {
      ...
      function Kn(n, t, e, r, s, o, f2, c) {
        ...
        if (!l && typeof n != "function")
          throw new wn($2);
        var v2 = r ? r.length : 0;
        if (v2 || (t &= ~(Hn | St), r = s = i), f2 = f2 === i ? f2 : Q3(R(f2), 0), c = c === i ? c : R(c), v2 -= s ? s.length : 0, t & St) {
          var _2 = r, m2 = s;
          r = s = i;
        }
        var P2 = l ? i : di(n), I = [n, t, e, r, s, _2, m2, o, f2, c];
        if (P2 && lh(I, P2), n = I[0], t = I[1], e = I[2], r = I[3], s = I[4], c = I[9] = I[9] === i ? l ? 0 : n.length : Q3(I[9] - v2, 0), !c && t & (Dn | yt) && (t &= ~(Dn | yt)), !t || t == vn)
          var E2 = Jc(n, t, e);
        else
          t == Dn || t == yt ? E2 = Xc(n, t, c) : (t == Hn || t == (vn | Hn)) && !s.length ? E2 = Qc(n, t, e, r) : E2 = Xe2.apply(i, I);
        var b2 = P2 ? iu : Nu;
        return $u(b2(E2, I), n, t);
      }
      function Eu(n, t, e, r) {
      ...
      function Su(n, t, e, r, s, o) {
        ...
        if (v2 && _2)
          return v2 == t && _2 == n;
        var m2 = -1, P2 = true, I = e & ve ? new gt() : i;
        for (o.set(n, t), o.set(t, n); ++m2 < c; ) {
          ...
          if (I) {
            if (!Nr(t, function(D2, N2) {
              if (!jt(I, N2) && (E2 === D2 || s(E2, D2, e, r, o)))
                return I.push(N2);
            })) {
              P2 = false;
              break;
      ...
      function nh(n, t, e, r, s, o) {
        var f2 = e & Et, c = li(n), l = c.length, v2 = li(t), _2 = v2.length;
        if (l != _2 && !f2)
          return false;
        for (var m2 = l; m2--; ) {
          var P2 = c[m2];
          if (!(f2 ? P2 in t : F.call(t, P2)))
            return false;
        }
        var I = o.get(n), E2 = o.get(t);
        if (I && E2)
          return I == t && E2 == n;
        var b2 = true;
        o.set(n, t), o.set(t, n);
        for (var y2 = f2; ++m2 < l; ) {
          ...
          var D2 = n[P2], N2 = t[P2];
          if (r)
            var dn = f2 ? r(N2, D2, P2, t, n, o) : r(D2, N2, P2, n, t, o);
      ...
      function Ru(n, t, e) {
        ...
        return o || ++r != s ? o : (s = n == null ? 0 : n.length, !!s && ar(s) && Zn(f2, s) && (O2(n) || Pt(n)));
      }
      function ih(n) {
...
`);
      ...
      function _i(n, t) {
        if (O2(n))
          return false;
        var e = typeof n;
        return e == "number" || e == "symbol" || e == "boolean" || n == null || pn(n) ? true : eo.test(n) || !to.test(n) || t != null && n in M2(t);
      }
      function oh(n) {
        var t = typeof n;
      ...
      function lh(n, t) {
        var e = n[1], r = t[1], s = e | r, o = s < (vn | ct | Mn), f2 = r == Mn && e == Dn || r == Mn && e == Kt && n[7].length <= t[8] || r == (Mn | Kt) && t[7].length <= t[8] && e == Dn;
        if (!(o || f2))
          return n;
      ...
      function Du(n, t, e) {
        return t = Q3(t === i ? n.length - 1 : t, 0), function() {
          for (var r = arguments, s = -1, o = Q3(r.length - t, 0), f2 = p2(o); ++s < o; )
            f2[s] = r[t + s];
          s = -1;
          for (var c = p2(t + 1); ++s < t; )
            c[s] = r[s];
      ...
      function _h(n, t, e) {
        ...
        if (!r || t < 1)
          return [];
        for (var s = 0, o = 0, f2 = p2(Ue(r / t)); s < r; )
          f2[o++] = Cn(n, s, s += t);
        return f2;
      }
      function mh(n) {
      ...
      function wh() {
        ...
        if (!n)
          return [];
        for (var t = p2(n - 1), e = arguments[0], r = n; r--; )
          t[r - 1] = arguments[r];
      ...
      var wl = Yn(function(n) {
        ...
        return t > 1 || this.__actions__.length || !(r instanceof H) || !Zn(e) ? this.thru(s) : (r = r.slice(e, +e + (t ? 1 : 0)), r.__actions__.push({ func: er, args: [s], thisArg: i }), new Pn(r, this.__chain__).thru(function(o) {
      ...
      var Ul = L2(function(n, t, e) {
        var r = -1, s = typeof t == "function", o = an(n) ? p2(n.length) : [];
        return rt(n, function(f2) {
          o[++r] = s ? cn(t, f2, e) : ae(f2, t, e);
        }), o;
      ...
      function Fl(n, t, e, r) {
        return n == null ? [] : (O2(t) || (t = t == null ? [] : [t]), e = r ? i : e, O2(e) || (e = e == null ? [] : [e]), tu(n, t, e));
      }
      ...
      function ql(n, t, e) {
        var r = O2(n) ? Hr : Es, s = arguments.length < 3;
        return r(n, x(t, 4), e, s, rt);
      }
      function Bl(n, t, e) {
        var r = O2(n) ? jo : Es, s = arguments.length < 3;
      ...
      function na(n, t, e) {
        var r, s, o, f2, c, l, v2 = 0, _2 = false, m2 = false, P2 = true;
        if (typeof n != "function")
          throw new wn($2);
        t = xn(t) || 0, K(e) && (_2 = !!e.leading, m2 = "maxWait" in e, o = m2 ? Q3(xn(e.maxWait) || 0, t) : o, P2 = "trailing" in e ? !!e.trailing : P2);
        function I(J) {
          var Tn = r, Qn = s;
          return r = s = i, v2 = J, f2 = n.apply(Qn, Tn), f2;
        }
        function E2(J) {
          return v2 = J, c = le(D2, t), _2 ? I(J) : f2;
        }
        function b2(J) {
          var Tn = J - l, Qn = J - v2, wa = t - Tn;
        ...
        function gn() {
          ...
          if (r = arguments, s = this, l = J, Tn) {
            if (c === i)
              return E2(l);
            if (m2)
              return cu(c), c = le(D2, t), I(l);
          }
          return c === i && (c = le(D2, t)), f2;
        }
      ...
      function Pp(n) {
        if (n == null)
          return true;
        if (an(n) && (O2(n) || typeof n == "string" || typeof n.splice == "function" || at(n) || Bt(n) || Pt(n)))
          return !n.length;
        var t = tn(n);
        if (t == yn || t == Sn)
          return !n.size;
      ...
      var sa = ws ? hn(ws) : Rc;
      function or(n) {
        return typeof n == "string" || !O2(n) && Y(n) && en(n) == Qt;
      }
      function pn(n) {
      ...
      var qp = L2(function(n, t) {
        ...
        for (s && rn(t[0], t[1], s) && (r = 1); ++e < r; )
          for (var o = t[e], f2 = on(o), c = -1, l = f2.length; ++c < l; ) {
            var v2 = f2[c], _2 = n[v2];
            (_2 === i || bn(_2, Nt[v2]) && !F.call(n, v2)) && (n[v2] = o[v2]);
          }
        return n;
      }), Bp = L2(function(n) {
      ...
      var rd = Ft(function(n, t, e) {
        ...
        }), Un2(n, pi(n), e), r && (e = An(e, Ln | Fn | xt, kc));
      ...
      function Nd(n, t, e) {
        ...
        var s = fr({}, t.imports, r.imports, Eu), o = V(s), f2 = Mr(s, o), c, l, v2 = 0, _2 = t.interpolate || Ce, m2 = "__p += '", P2 = Br((t.escape || Ce).source + "|" + _2.source + "|" + (_2 === Zi ? lo : Ce).source + "|" + (t.evaluate || Ce).source + "|$", "g"), I = "//# sourceURL=" + (F.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Go + "]") + `
`;
        n.replace(P2, function(y2, D2, N2, dn, sn, gn) {
          return N2 || (N2 = dn), m2 += n.slice(v2, gn).replace(Po, cf), D2 && (c = true, m2 += `' +
__e(` + D2 + `) +
'`), sn && (l = true, m2 += `';
` + sn + `;
__p += '`), N2 && (m2 += `' +
...
`) + m2 + `return __p
        ...
        var b2 = _a(function() {
          return U3(o, I + "return " + m2).apply(i, f2);
        });
        if (b2.source = m2, Ei(b2))
          throw b2;
        return b2;
      }
      function $d(n) {
      ...
      function qd(n, t) {
        ...
        if (f2 && (c += l.length - c), yi(s)) {
          if (n.slice(c).search(s)) {
            var v2, _2 = l;
            for (s.global || (s = Br(s.source, W(Ji.exec(s)) + "g")), s.lastIndex = 0; v2 = s.exec(_2); )
              var m2 = v2.index;
      ...
      var eg = ci(G2), rg = ci(As), ig = ci(Nr);
      function ma(n) {
      ...
      function lg(n) {
        return O2(n) ? G2(n, Wn) : pn(n) ? [n] : un(Wu(W(n)));
      }
      function pg(n) {
        var t = ++xf;
        return W(n) + t;
      ...
      return a.after = Ql, a.ary = Xu, a.assign = Up, a.assignIn = fa, a.assignInWith = fr, a.assignWith = Wp, a.at = Fp, a.before = Qu, a.bind = Ii, a.bindAll = zd, a.bindKey = Vu, a.castArray = op, a.chain = Yu, a.chunk = _h, a.compact = mh, a.concat = wh, a.cond = Kd, a.conforms = Yd, a.constant = bi, a.countBy = Sl, a.create = Mp, a.curry = ku, a.curryRight = ju, a.debounce = na, a.defaults = qp, a.defaultsDeep = Bp, a.defer = Vl, a.delay = kl, a.difference = Ph, a.differenceBy = Ah, a.differenceWith = Ch, a.drop = Ih, a.dropRight = xh, a.dropRightWhile = Eh, a.dropWhile = yh, a.fill = Sh, a.filter = Rl, a.flatMap = Ll, a.flatMapDeep = Dl, a.flatMapDepth = Hl, a.flatten = Bu, a.flattenDeep = Oh, a.flattenDepth = Rh, a.flip = jl, a.flow = Jd, a.flowRight = Xd, a.fromPairs = bh, a.functions = Xp, a.functionsIn = Qp, a.groupBy = Nl, a.initial = Lh, a.intersection = Dh, a.intersectionBy = Hh, a.intersectionWith = Nh, a.invert = kp, a.invertBy = jp, a.invokeMap = Ul, a.iteratee = Ti, a.keyBy = Wl, a.keys = V, a.keysIn = on, a.map = rr, a.mapKeys = td, a.mapValues = ed, a.matches = Qd, a.matchesProperty = Vd, a.memoize = sr, a.merge = rd, a.mergeWith = ca, a.method = kd, a.methodOf = jd, a.mixin = Li, a.negate = ur, a.nthArg = tg, a.omit = id, a.omitBy = sd, a.once = np, a.orderBy = Fl, a.over = eg, a.overArgs = tp, a.overEvery = rg, a.overSome = ig, a.partial = xi, a.partialRight = ta, a.partition = Ml, a.pick = ud, a.pickBy = ha, a.property = ma, a.propertyOf = sg, a.pull = Fh, a.pullAll = zu, a.pullAllBy = Mh, a.pullAllWith = qh, a.pullAt = Bh, a.range = ug, a.rangeRight = ag, a.rearg = ep, a.reject = Gl, a.remove = Gh, a.rest = rp, a.reverse = Ai, a.sampleSize = Kl, a.set = od, a.setWith = fd, a.shuffle = Yl, a.slice = zh, a.sortBy = Xl, a.sortedUniq = Vh, a.sortedUniqBy = kh, a.split = Ld, a.spread = ip, a.tail = jh, a.take = nl, a.takeRight = tl, a.takeRightWhile = el, a.takeWhile = rl, a.tap = ml, a.throttle = sp, a.thru = er, a.toArray = ua, a.toPairs = la, a.toPairsIn = pa, a.toPath = lg, a.toPlainObject = oa, a.transform = cd, a.unary = up, a.union = il, a.unionBy = sl, a.unionWith = ul, a.uniq = al, a.uniqBy = ol, a.uniqWith = fl, a.unset = hd, a.unzip = Ci, a.unzipWith = Ku, a.update = ld, a.updateWith = pd, a.values = Gt, a.valuesIn = dd, a.without = cl, a.words = va, a.wrap = ap, a.xor = hl, a.xorBy = ll, a.xorWith = pl, a.zip = dl, a.zipObject = gl, a.zipObjectDeep = vl, a.zipWith = _l, a.entries = la, a.entriesIn = pa, a.extend = fa, a.extendWith = fr, Li(a, a), a.add = dg, a.attempt = _a, a.camelCase = md, a.capitalize = da, a.ceil = gg, a.clamp = gd, a.clone = fp, a.cloneDeep = hp, a.cloneDeepWith = lp, a.cloneWith = cp, a.conformsTo = pp, a.deburr = ga, a.defaultTo = Zd, a.divide = vg, a.endsWith = wd, a.eq = bn, a.escape = Pd, a.escapeRegExp = Ad, a.every = Ol, a.find = bl, a.findIndex = Mu, a.findKey = Gp, a.findLast = Tl, a.findLastIndex = qu, a.findLastKey = zp, a.floor = _g, a.forEach = Zu, a.forEachRight = Ju, a.forIn = Kp, a.forInRight = Yp, a.forOwn = Zp, a.forOwnRight = Jp, a.get = Si, a.gt = dp, a.gte = gp, a.has = Vp, a.hasIn = Oi, a.head = Gu, a.identity = fn, a.includes = $l, a.indexOf = Th, a.inRange = vd, a.invoke = nd, a.isArguments = Pt, a.isArray = O2, a.isArrayBuffer = vp, a.isArrayLike = an, a.isArrayLikeObject = Z, a.isBoolean = _p, a.isBuffer = at, a.isDate = mp, a.isElement = wp, a.isEmpty = Pp, a.isEqual = Ap, a.isEqualWith = Cp, a.isError = Ei, a.isFinite = Ip, a.isFunction = Jn, a.isInteger = ea, a.isLength = ar, a.isMap = ra, a.isMatch = xp, a.isMatchWith = Ep, a.isNaN = yp, a.isNative = Sp, a.isNil = Rp, a.isNull = Op, a.isNumber = ia, a.isObject = K, a.isObjectLike = Y, a.isPlainObject = pe, a.isRegExp = yi, a.isSafeInteger = bp, a.isSet = sa, a.isString = or, a.isSymbol = pn, a.isTypedArray = Bt, a.isUndefined = Tp, a.isWeakMap = Lp, a.isWeakSet = Dp, a.join = $h, a.kebabCase = Cd, a.last = In, a.lastIndexOf = Uh, a.lowerCase = Id, a.lowerFirst = xd, a.lt = Hp, a.lte = Np, a.max = mg, a.maxBy = wg, a.mean = Pg, a.meanBy = Ag, a.min = Cg, a.minBy = Ig, a.stubArray = Hi, a.stubFalse = Ni, a.stubObject = og, a.stubString = fg, a.stubTrue = cg, a.multiply = xg, a.nth = Wh, a.noConflict = ng, a.noop = Di, a.now = ir, a.pad = Ed, a.padEnd = yd, a.padStart = Sd, a.parseInt = Od, a.random = _d, a.reduce = ql, a.reduceRight = Bl, a.repeat = Rd, a.replace = bd, a.result = ad, a.round = Eg, a.runInContext = h, a.sample = zl, a.size = Zl, a.snakeCase = Td, a.some = Jl, a.sortedIndex = Kh, a.sortedIndexBy = Yh, a.sortedIndexOf = Zh, a.sortedLastIndex = Jh, a.sortedLastIndexBy = Xh, a.sortedLastIndexOf = Qh, a.startCase = Dd, a.startsWith = Hd, a.subtract = yg, a.sum = Sg, a.sumBy = Og, a.template = Nd, a.times = hg, a.toFinite = Xn, a.toInteger = R, a.toLength = aa, a.toLower = $d, a.toNumber = xn, a.toSafeInteger = $p, a.toString = W, a.toUpper = Ud, a.trim = Wd, a.trimEnd = Fd, a.trimStart = Md, a.truncate = qd, a.unescape = Bd, a.uniqueId = pg, a.upperCase = Gd, a.upperFirst = Ri, a.each = Zu, a.eachRight = Ju, a.first = Gu, Li(a, function() {
      ...
      }, H.prototype.invokeMap = L2(function(n, t) {
        ...
        s && (a.prototype[t] = function() {
          var f2 = this.__wrapped__, c = r ? [1] : arguments, l = f2 instanceof H, v2 = c[0], _2 = l || O2(f2), m2 = function(D2) {
            var N2 = s.apply(a, nt([D2], c));
            return r && P2 ? N2[0] : N2;
          };
          _2 && e && typeof v2 == "function" && v2.length != 1 && (l = _2 = false);
          var P2 = this.__chain__, I = !!this.__actions__.length, E2 = o && !P2, b2 = l && !I;
          if (!o && _2) {
            f2 = b2 ? f2 : new H(this);
            var y2 = n.apply(f2, c);
            return y2.__actions__.push({ func: er, args: [m2], thisArg: i }), new Pn(y2, P2);
          }
        ...
        if (e) {
          var r = e.name + "";
          F.call(Ut, r) || (Ut[r] = []), Ut[r].push({ name: t, func: e });
        }
      }), Ut[Xe2(i, ct).name] = [{ name: "wrapper", func: i }], H.prototype.clone = Bf, H.prototype.reverse = Gf, H.prototype.value = zf, a.prototype.at = wl, a.prototype.chain = Pl, a.prototype.commit = Al, a.prototype.next = Cl, a.prototype.plant = xl, a.prototype.reverse = El, a.prototype.toJSON = a.prototype.valueOf = a.prototype.value = yl, a.prototype.first = a.prototype.head, ne && (a.prototype[ne] = Il), a;
    }, Ht = Af();
    lt ? ((lt.exports = Ht)._ = Ht, Tr._ = Ht) : k2._ = Ht;
  }).call(ge2);
})(Ui, Ui.exports);
...
function ft(C, u2, i) {
  var d;
  const w = ge(C);
  return ((d = u2.rpcMap) == null ? void 0 : d[w.reference]) || `${Mg}?chainId=${w.namespace}:${w.reference}&projectId=${i}`;
}
function Ct(C) {
...
function Zg(C, u2) {
  const i = Object.keys(u2.namespaces).filter((w) => w.includes(C));
  if (!i.length)
    return [];
  const d = [];
  return i.forEach((w) => {
    const T = u2.namespaces[w].accounts;
    d.push(...T);
  }), d;
}
function Jg(C = {}, u2 = {}) {
  const i = Oa(C), d = Oa(u2);
...
function Oa(C) {
  ...
  for (const [$2, En] of Object.entries(C)) {
    const zt = oe($2) ? [$2] : En.chains, pr = En.methods || [], It = En.events || [], Ln = En.rpcMap || {}, Fn = Xe($2);
    T[Fn] = Yg(cr(cr({}, T[Fn]), En), { chains: S(zt, (u2 = T[Fn]) == null ? void 0 : u2.chains), methods: S(pr, (i = T[Fn]) == null ? void 0 : i.methods), events: S(It, (d = T[Fn]) == null ? void 0 : d.events), rpcMap: cr(cr({}, Ln), (w = T[Fn]) == null ? void 0 : w.rpcMap) });
  }
  return T;
}
function Xg(C) {
...
function Qg(C) {
  ...
  for (const [i, d] of Object.entries(C)) {
    const w = d.methods || [], T = d.events || [], $2 = d.accounts || [], En = oe(i) ? [i] : d.chains ? d.chains : Sa(d.accounts);
    u2[i] = { chains: En, methods: w, events: T, accounts: $2 };
  }
  return u2;
}
function Wi(C) {
...
var Vg = class {
  ...
  createHttpProviders() {
    ...
    return this.namespace.chains.forEach((i) => {
      var d;
      const w = Ct(i);
      u2[w] = this.createHttpProvider(w, (d = this.namespace.rpcMap) == null ? void 0 : d[i]);
    }), u2;
  }
  getHttpProvider() {
  ...
  setHttpProvider(u2, i) {
    const d = this.createHttpProvider(u2, i);
    d && (this.httpProviders[u2] = d);
  }
  createHttpProvider(u2, i) {
    const d = i || ft(u2, this.namespace, this.client.core.projectId);
    if (!d)
      throw new Error(`No RPC url provided for chainId: ${u2}`);
    return new JsonRpcProvider(new esm_default(d, z("disableProviderPing")));
  }
};
var kg = class {
  constructor(u2) {
  ...
  createHttpProvider(u2, i) {
    const d = i || ft(`${this.name}:${u2}`, this.namespace, this.client.core.projectId);
    if (!d)
      throw new Error(`No RPC url provided for chainId: ${u2}`);
    return new JsonRpcProvider(new HttpConnection(d, z("disableProviderPing")));
  }
  setHttpProvider(u2, i) {
    const d = this.createHttpProvider(u2, i);
    d && (this.httpProviders[u2] = d);
  ...
  async handleSwitchChain(u2) {
    var i, d;
    let w = u2.request.params ? (i = u2.request.params[0]) == null ? void 0 : i.chainId : "0x0";
    w = w.startsWith("0x") ? w : `0x${w}`;
    const T = parseInt(w, 16);
    if (this.isChainApproved(T))
      this.setDefaultChain(`${T}`);
    else if (this.namespace.methods.includes("wallet_switchEthereumChain"))
      await this.client.request({ topic: u2.topic, request: { method: u2.request.method, params: [{ chainId: w }] }, chainId: (d = this.namespace.chains) == null ? void 0 : d[0] }), this.setDefaultChain(`${T}`);
    else
...
var tv = class {
  ...
  createHttpProviders() {
    ...
    return this.namespace.chains.forEach((i) => {
      ...
      u2[w] = this.createHttpProvider(w, d);
    }), u2;
  }
  getHttpProvider() {
    const u2 = `${this.name}:${this.chainId}`, i = this.httpProviders[u2];
  ...
  createHttpProvider(u2, i) {
    const d = i || this.getCardanoRPCUrl(u2);
    if (!d)
      throw new Error(`No RPC url provided for chainId: ${u2}`);
    return new JsonRpcProvider(new esm_default(d, z("disableProviderPing")));
  }
...
var iv = class {
  ...
  setDefaultChain(u2, i) {
    if (this.chainId = u2, !this.httpProviders[u2]) {
      const d = i || ft(`${this.name}:${u2}`, this.namespace);
      if (!d)
        throw new Error(`No RPC url provided for chainId: ${u2}`);
      this.setHttpProvider(u2, d);
    }
  ...
  createHttpProviders() {
    ...
    return this.namespace.chains.forEach((i) => {
      var d;
      u2[i] = this.createHttpProvider(i, (d = this.namespace.rpcMap) == null ? void 0 : d[i]);
    }), u2;
  }
  getHttpProvider() {
    const u2 = `${this.name}:${this.chainId}`, i = this.httpProviders[u2];
  ...
  createHttpProvider(u2, i) {
    const d = i || ft(u2, this.namespace);
    return typeof d > "u" ? void 0 : new JsonRpcProvider(new esm_default(d, z("disableProviderPing")));
  }
};
...
var lr = class {
  ...
  async request(u2, i) {
    ...
    return await this.getProvider(d).request({ request: hr({}, u2), chainId: `${d}:${w}`, topic: this.session.topic });
  }
  sendAsync(u2, i, d) {
    this.request(u2, d).then((w) => i(null, w)).catch((w) => i(w, void 0));
  }
  async enable() {
    if (!this.client)
  ...
  async pair(u2) {
    ...
    do {
      ...
      const { uri: d, approval: w } = await this.client.connect({ pairingTopic: u2, requiredNamespaces: this.namespaces, optionalNamespaces: this.optionalNamespaces, sessionProperties: this.sessionProperties });
  ...
  setDefaultChain(u2, i) {
    try {
      if (!this.session)
        return;
      const [d, w] = this.validateChain(u2);
      this.getProvider(d).setDefaultChain(w, i);
    } catch (d) {
      if (!/Please call connect/.test(d.message))
        throw d;
    }
  }
  async cleanupPendingPairings(u2 = {}) {
    ...
    if (k(i)) {
      for (const d of i)
        u2.deletePairings ? this.client.core.expirer.set(d.topic, 0) : await this.client.core.relayer.subscriber.unsubscribe(d.topic);
  ...
  createProviders() {
    ...
    Fi("client", this.client), Fi("events", this.events), Fi("disableProviderPing", this.disableProviderPing), u2.forEach((i) => {
      if (!this.session)
        return;
      const d = Zg(i, this.session), w = Sa(d), T = Jg(this.namespaces, this.optionalNamespaces), $2 = Mi(hr({}, T[i]), { accounts: d, chains: w });
      switch (i) {
        case "eip155":
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (u2) => {
      ...
      const { params: i } = u2, { event: d } = i;
      if (d.name === "accountsChanged") {
        const w = d.data;
        w && k(w) && this.events.emit("accountsChanged", w.map(Xg));
      } else if (d.name === "chainChanged") {
        const w = i.chainId, T = i.event.data, $2 = Xe(w), En = Wi(w) !== Wi(T) ? `${$2}:${Wi(T)}` : w;
        this.onChainChanged(En);
      } else
        this.events.emit(d.name, d.data);
      this.events.emit("session_event", u2);
    }), this.client.on("session_update", ({ topic: u2, params: i }) => {
      var d;
      const { namespaces: w } = i, T = (d = this.client) == null ? void 0 : d.session.get(u2);
      this.session = Mi(hr({}, T), { namespaces: w }), this.onSessionUpdate(), this.events.emit("session_update", { topic: u2, params: i });
  ...
  setNamespaces(u2) {
    const { namespaces: i, optionalNamespaces: d, sessionProperties: w } = u2;
  ...
  validateChain(u2) {
    const [i, d] = (u2 == null ? void 0 : u2.split(":")) || ["", ""];
    if (!this.namespaces || !Object.keys(this.namespaces).length)
      return [i, d];
    if (i && !Object.keys(this.namespaces || {}).map(($2) => Xe($2)).includes(i))
      throw new Error(`Namespace '${i}' is not configured. Please call connect() first with namespace config.`);
    if (i && d)
      return [i, d];
    const w = Xe(Object.keys(this.namespaces)[0]), T = this.rpcProviders[w].getDefaultChain();
    return [w, T];
  }
  ...
  onChainChanged(u2, i = false) {
    ...
    if (!this.namespaces)
      return;
    const [w, T] = this.validateChain(u2);
...
var _ = ["chainChanged", "accountsChanged", "message", "disconnect", "connect"];
...
var p = (a, t) => {
  for (var s in t || (t = {}))
    U2.call(t, s) && O(a, s, t[s]);
  if (y)
    for (var s of y(t))
      Q2.call(t, s) && O(a, s, t[s]);
  return a;
};
var M = (a, t) => q(a, D(t));
function g(a) {
...
function L(a) {
  ...
  const C = (r == null ? void 0 : r.length) && (d == null ? void 0 : d.length) || !s, I = { chains: [...new Set(C ? o.chains.concat(s || []) : s)], methods: [...new Set(o.methods.concat(n != null && n.length ? n : E))], events: [...new Set(o.events.concat(h != null && h.length ? h : _))], rpcMap: c };
...
var v = class {
  ...
  async connect(t) {
    ...
    try {
      const n = await new Promise(async (h, c) => {
        ...
        })), await this.signer.connect(M(p({ namespaces: p({}, s && { [this.namespace]: s }) }, i && { optionalNamespaces: { [this.namespace]: i } }), { pairingTopic: t == null ? void 0 : t.pairingTopic })).then((r) => {
          h(r);
        }).catch((r) => {
  ...
  registerEventListeners() {
    this.signer.on("session_event", (t) => {
      ...
      this.reset(), this.events.emit("session_delete", t), this.events.emit("disconnect", M(p({}, U("USER_DISCONNECTED")), { data: t.topic, name: "USER_DISCONNECTED" }));
  ...
  getRpcConfig(t) {
    ...
    const c = n.length ? (t == null ? void 0 : t.methods) || u : [], o = n.length ? (t == null ? void 0 : t.events) || m : [], r = (t == null ? void 0 : t.optionalMethods) || [], d = (t == null ? void 0 : t.optionalEvents) || [], C = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(h, t.projectId), I = (t == null ? void 0 : t.qrModalOptions) || void 0;
    return { chains: n == null ? void 0 : n.map((l) => this.formatChainId(l)), optionalChains: e.map((l) => this.formatChainId(l)), methods: c, events: o, optionalMethods: r, optionalEvents: d, rpcMap: C, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: I, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, s) {
    const i = {};
    return t.forEach((n) => {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g(this.rpc.chains) : g(this.rpc.optionalChains), this.signer = await cv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i } = await import("./dist-25ZPBHRS.js");
        s = i;
      } catch {
  ...
  loadConnectOpts(t) {
    ...
    })), i && k(i) && (this.rpc.optionalChains = [], this.rpc.optionalChains = i == null ? void 0 : i.map((e) => this.formatChainId(e)), i.forEach((e) => {
      this.rpc.rpcMap[e] = (n == null ? void 0 : n[e]) || this.getRpcUrl(e);
    }));
  }
  getRpcUrl(t, s) {
...
*/
//# sourceMappingURL=index.es-GOUVDFJ2.js.map
