...
var require_Web3Response = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/relay/Web3Response.js"(exports) {
    ...
    function isErrorResponse(response) {
      var _a, _b;
      return ((_a = response) === null || _a === void 0 ? void 0 : _a.method) !== void 0 && ((_b = response) === null || _b === void 0 ? void 0 : _b.errorMessage) !== void 0;
    }
...
var require_errors2 = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/errors.js"(exports) {
    ...
    function standardErrorMessage(code) {
      return code !== void 0 ? (0, eth_rpc_errors_1.getMessageFromCode)(code) : "Unknown error";
    }
  ...
  "node_modules/qs/lib/utils.js"(exports, module) {
    ...
    var encode = function encode2(str, defaultEncoder, charset, kind, format) {
      ...
      for (var i3 = 0; i3 < string2.length; ++i3) {
        ...
        i3 += 1;
        c3 = 65536 + ((c3 & 1023) << 10 | string2.charCodeAt(i3) & 1023);
...
var require_stringify = __commonJS({
  "node_modules/qs/lib/stringify.js"(exports, module) {
    ...
    var sentinel = {};
    var stringify = function stringify2(object2, prefix, generateArrayPrefix, commaRoundTrip, strictNullHandling, skipNulls, encoder, filter2, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
      var obj = object2;
...
var require_util3 = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/util.js"(exports, module) {
    ...
    function toBuffer(v3) {
      if (!import_buffer.Buffer.isBuffer(v3)) {
        if (Array.isArray(v3)) {
          v3 = import_buffer.Buffer.from(v3);
        } else if (typeof v3 === "string") {
          if (isHexString(v3)) {
            v3 = import_buffer.Buffer.from(padToEven(stripHexPrefix(v3)), "hex");
          } else {
            v3 = import_buffer.Buffer.from(v3);
          }
          ...
          v3 = import_buffer.Buffer.allocUnsafe(0);
        } else if (BN.isBN(v3)) {
          v3 = v3.toArrayLike(import_buffer.Buffer);
        } else if (v3.toArray) {
          v3 = import_buffer.Buffer.from(v3.toArray());
        } else {
  ...
  "node_modules/@coinbase/wallet-sdk/dist/vendor-js/eth-eip712-util/abi.js"(exports, module) {
    ...
    function encodeSingle(type2, arg) {
      ...
      if (type2 === "address") {
        ...
        return num.toArrayLike(import_buffer.Buffer, "be", 32);
        ...
        return num.toTwos(256).toArrayLike(import_buffer.Buffer, "be", 32);
    ...
    function solidityPack(types, values) {
      ...
      for (var i3 = 0; i3 < types.length; i3++) {
        ...
        if (type2 === "bytes") {
          ...
          ret.push(num.toArrayLike(import_buffer.Buffer, "be", size2 / 8));
        } else if (type2.startsWith("int")) {
          size2 = parseTypeN(type2);
          if (size2 % 8 || size2 < 8 || size2 > 256) {
            throw new Error("Invalid int<N> width: " + size2);
          ...
          ret.push(num.toTwos(size2).toArrayLike(import_buffer.Buffer, "be", size2 / 8));
        } else {
          throw new Error("Unsupported or invalid type: " + type2);
        }
      }
...
function size(struct2, min3, max3 = min3) {
  ...
  return refine(struct2, "size", (value) => {
    if (typeof value === "number" || value instanceof Date) {
      ...
      const { length } = value;
      return min3 <= length && length <= max3 || `${expected} with a length ${of2} but received one with a length of \`${length}\``;
    }
  });
}
...
var require_bytes = __commonJS({
  "node_modules/@metamask/utils/dist/bytes.js"(exports) {
    ...
    function createDataView(bytes) {
      if (typeof import_buffer.Buffer !== "undefined" && bytes instanceof import_buffer.Buffer) {
  ...
  "node_modules/@coinbase/wallet-sdk/dist/provider/CoinbaseWalletProvider.js"(exports) {
    ...
    var CoinbaseWalletProvider = class extends safe_event_emitter_1.default {
      ...
      _prepareTransactionParams(tx) {
        ...
        const data = tx.data ? (0, util_1.ensureBuffer)(tx.data) : import_buffer.Buffer.alloc(0);
...
function L(n2, u3, t3, i3, o3, r4, f3, e3, c3, s3) {
  ...
  n:
    if ("function" == typeof A3)
      try {
        ...
        p3.state = p3.__s, null != p3.getChildContext && (i3 = v(v({}, i3), p3.getChildContext())), y3 || null == p3.getSnapshotBeforeUpdate || (m3 = p3.getSnapshotBeforeUpdate(d3, _3)), C(n2, h(T3 = null != a3 && a3.type === g && null == a3.key ? a3.props.children : a3) ? T3 : [T3], u3, t3, i3, o3, r4, f3, e3, c3, s3), p3.base = u3.__e, u3.__u &= -161, p3.__h.length && f3.push(p3), k3 && (p3.__E = p3.__ = null);
      } catch (n3) {
        u3.__v = null, c3 || null != r4 ? (u3.__e = e3, u3.__u |= c3 ? 160 : 32, r4[r4.indexOf(e3)] = null) : (u3.__e = t3.__e, u3.__k = t3.__k), l.__e(n3, u3, t3);
      }
    else
      null == r4 && u3.__v === t3.__v ? (u3.__k = t3.__k, u3.__e = t3.__e) : u3.__e = j(t3.__e, u3, t3, i3, o3, r4, f3, c3, s3);
  (a3 = l.diffed) && a3(u3);
}
function M(n2, u3, t3) {
  u3.__d = void 0;
...
function j(l3, u3, t3, i3, o3, r4, f3, e3, s3) {
  ...
  if (null == l3) {
    ...
    l3 = o3 ? document.createElementNS("http://www.w3.org/2000/svg", x3) : document.createElement(x3, w3.is && w3), r4 = null, e3 = false;
  }
  if (null === x3)
    k3 === w3 || e3 && l3.data === w3 || (l3.data = w3);
  else {
    if (r4 = r4 && n.call(l3.childNodes), k3 = t3.props || c, !e3 && null != r4)
    ...
    else if (y3 && (l3.innerHTML = ""), C(l3, h(d3) ? d3 : [d3], u3, t3, i3, o3 && "foreignObject" !== x3, r4, f3, r4 ? r4[0] : t3.__k && m(t3, 0), e3, s3), null != r4)
      for (a3 = r4.length; a3--; )
        null != r4[a3] && p(r4[a3]);
...
function q(u3, t3, i3) {
  var o3, r4, f3, e3;
  l.__ && l.__(u3, t3), r4 = (o3 = "function" == typeof i3) ? null : i3 && i3.__k || t3.__k, f3 = [], e3 = [], L(t3, u3 = (!o3 && i3 || t3).__k = y(g, null, [u3]), r4 || c, c, void 0 !== t3.ownerSVGElement, !o3 && i3 ? [i3] : r4 ? null : t3.firstChild ? n.call(t3.childNodes) : null, f3, !o3 && i3 ? i3 : r4 ? r4.__e : t3.firstChild, o3, e3), M(f3, u3, e3);
}
function B(n2, l3) {
  q(n2, l3, B);
}
...
var init_Subscription = __esm({
  "node_modules/rxjs/_esm5/internal/Subscription.js"() {
    ...
    Subscription = function() {
      ...
      Subscription2.EMPTY = function(empty4) {
        empty4.closed = true;
        return empty4;
      }(new Subscription2());
  ...
  "node_modules/rxjs/_esm5/internal/util/subscribeToArray.js"() {
    ...
    subscribeToArray = function(array2) {
      return function(subscriber) {
        for (var i3 = 0, len = array2.length; i3 < len && !subscriber.closed; i3++) {
  ...
  if (typeof resultSelector === "function") {
    return function(source) {
      return source.pipe(mergeMap(function(a3, i3) {
        return from(project(a3, i3)).pipe(map2(function(b3, ii) {
...
function defer(observableFactory) {
  return new Observable(function(subscriber) {
    ...
    var source = input ? from(input) : empty3();
...
var init_hooks_module = __esm({
  "node_modules/preact/hooks/dist/hooks.module.js"() {
    ...
    l.__b = function(n2) {
      ...
      })) : (i3.__h.forEach(k2), i3.__h.forEach(w2), i3.__h = [], t2 = 0)), u2 = r3;
  ...
  "node_modules/@coinbase/wallet-sdk/dist/components/QRCode.js"(exports) {
    ...
    var QRCode = (props) => {
      ...
      (0, hooks_1.useEffect)(() => {
        ...
        const base64 = import_buffer.Buffer.from(qrcode.svg(), "utf8").toString("base64");
...
function endWith() {
  ...
  return function(source) {
    return concat(source, of.apply(void 0, array2));
  };
}
...
function max2(comparer) {
  var max3 = typeof comparer === "function" ? function(x3, y3) {
...
function min2(comparer) {
  var min3 = typeof comparer === "function" ? function(x3, y3) {
    return comparer(x3, y3) < 0 ? x3 : y3;
  } : function(x3, y3) {
    return x3 < y3 ? x3 : y3;
  };
...
function pluck() {
  ...
  return function(source) {
    return map2(plucker(properties, length))(source);
  };
}
...
function startWith() {
  ...
  if (isScheduler(scheduler)) {
    array2.pop();
    return function(source) {
      return concat(array2, source, scheduler);
    };
  } else {
    return function(source) {
      return concat(array2, source);
    };
  }
}
...
function timeInterval(scheduler) {
  ...
  return function(source) {
    return defer(function() {
      ...
      }, { current: scheduler.now(), value: void 0, last: void 0 }), map2(function(_a) {
  ...
  "node_modules/@coinbase/wallet-sdk/dist/connection/WalletSDKConnection.js"(exports) {
    ...
    var WalletSDKConnection = class {
      constructor(sessionId, sessionKey, linkAPIUrl, diagnostic, WebSocketClass = WebSocket) {
        ...
        ).subscribe((i3) => i3 === 0 ? this.updateLastHeartbeat() : this.heartbeat()));
...
***************************************************************************** */
//# sourceMappingURL=dist-HYSC2IR6.js.map
