...
// node_modules/@magic-ext/oauth/dist/es/index.js
init_shim();
...
var Ct = typeof import_process.default == "object" && import_process.default.env && import_process.default.env.NODE_DEBUG && /\bsemver\b/i.test(import_process.default.env.NODE_DEBUG) ? (...n) => console.error("SEMVER", ...n) : () => {
};
var m2 = Ct;
...
function ft() {
  return x(this, null, function* () {
    ...
    let r2 = { iat: Math.floor(new Date().getTime() / 1e3), jti: mt() }, o2 = { typ: "dpop+jwt", alg: "ES256", jwk: n }, s = { protected: ht(JSON.stringify(o2)), claims: ht(JSON.stringify(r2)) }, a2 = Fn(`${s.protected}.${s.claims}`), i = { name: we, hash: { name: "SHA-256" } }, c2 = jn(new Uint8Array(yield e.sign(i, t, a2)));
...
var ke2 = $e2((qe2, Ne2) => {
  (function(b2) {
    if (typeof qe2 == "object" && typeof Ne2 < "u")
      ...
      var A;
      typeof window < "u" ? A = window : typeof _global < "u" ? A = _global : typeof self < "u" ? A = self : A = this, A.localforage = b2();
    }
  })(function() {
    var b2, A, R;
    return function L2(D3, X2, P) {
      ...
      }).call(this, typeof _global < "u" ? _global : typeof self < "u" ? self : typeof window < "u" ? window : {});
    }, {}], 2: [function(L2, D3, X2) {
      "use strict";
      var P = L2(1);
      function Y3() {
...
var k2 = H2((I2, F2) => {
  (function(n, r2) {
    ...
    var n = n || function(r2, s) {
      ...
      }(), h2 = {}, w2 = h2.lib = {}, R = w2.Base = function() {
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-magic.browser.esm-B4J7DQ6G.js.map
