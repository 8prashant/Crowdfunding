...
var wr = ({
  ...
  const [u, x] = (0, import_react.useState)(false), [d, k] = (0, import_react.useState)(
    ...
    f && b.scrollStyles,
    e
  ), T = (0, import_react.useRef)(null), y = o != null ? o : T, { onTransitionHide: O } = we(y.current), R = (0, import_react.useCallback)(() => {
    u && k(void 0);
  }, [u]);
  return (0, import_react.useEffect)(() => {
    var $, F;
...
var Pr = ({
  ...
  const [u, x] = (0, import_react.useState)(t != null ? t : false), [d, k] = (0, import_react.useState)(false), p = (0, import_react.useRef)(null), h = (0, import_react.useCallback)(
    (g, b) => {
      if (i)
  ...
  (0, import_react.useEffect)(() => {
    (async () => {
      const {
        ...
        Tooltip: B,
        SubTitle: W
      } = await import("./chart-TNXO54TN.js");
      m.register(
        a,
        u,
        x,
...
var Fr = ({
  ...
  return (0, import_react.useEffect)(() => {
    ...
    (async () => {
      const M = await import("./chartjs-plugin-datalabels.esm-N4VZO2AD.js");
      x.current = M.default;
    })();
