...
import {
  TokenERC20History
} from "./chunk-6FXLMNP2.js";
import {
  StandardErc20
} from "./chunk-PPLMEUGI.js";
import {
  ListingType,
  MarketplaceAuction,
  MarketplaceDirect
...
import {
  hasERC20Allowance
} from "./chunk-F4UXV5WM.js";
import {
  StandardErc721
} from "./chunk-S7U3AI35.js";
import {
  DropErc1155History
...
function useSafe() {
  ...
  return (0, import_react.useCallback)(async (connectProps) => {
    ...
    } = await import("./safeWallet-1c3642a3.browser.esm-MAAZOZSK.js");
...
function useMagic() {
  ...
  return (0, import_react2.useCallback)(async (options) => {
    ...
    } = await import("./magicLink-a4683714.browser.esm-7BXGTWW4.js");
  ...
  return {
    ...
    create(options) {
      ...
      return new EmbeddedWallet({
        ...options,
        ...config,
        clientId: (_a = options == null ? void 0 : options.clientId) != null ? _a : ""
      });
    },
    selectUI(props) {
