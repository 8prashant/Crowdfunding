...
var FrameConnector = class extends WagmiConnector {
  constructor(_ref) {
    let {
      chains,
  ...
  async isAuthorized() {
    try {
      if (this.options.shimDisconnect && !this.connectorStorage.getItem(this.shimDisconnectKey)) {
        return false;
      }
      const provider = await this.getProvider();
      if (!provider) {
  ...
  async createProvider() {
    const ethProvider = (await import("./browser-4IW26WPV.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-frame.browser.esm-J3ECL6WG.js.map
