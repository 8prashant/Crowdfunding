...
// node_modules/@thirdweb-dev/wallets/dist/smart-wallet-f5e628ca.browser.esm.js
init_shim();
...
function nt(r) {
  const t = kt(r.aud), e2 = new RegExp(`${r.domain}`).test(r.aud), i2 = !!r.nonce, n = r.type ? r.type === "eip4361" : true, s = r.expiry;
  if (s && !Xt(s, U)) {
...
function ut(r, t) {
  ...
  function f2(D4) {
    ...
    if (D4.length === 0)
      return "";
    for (var l2 = 0, m2 = 0, E2 = 0, y2 = D4.length; E2 !== y2 && D4[E2] === 0; )
      E2++, l2++;
    for (var w2 = (y2 - E2) * h + 1 >>> 0, g2 = new Uint8Array(w2); E2 !== y2; ) {
      for (var C2 = D4[E2], _3 = 0, b2 = w2 - 1; (C2 !== 0 || _3 < m2) && b2 !== -1; b2--, _3++)
    ...
    if (D4[l2] !== " ") {
      ...
      if (D4[l2] !== " ") {
        for (var b2 = y2 - E2; b2 !== y2 && w2[b2] === 0; )
          b2++;
        for (var v = new Uint8Array(m2 + (y2 - b2)), q = m2; b2 !== y2; )
          v[q++] = w2[b2++];
        return v;
      }
    }
...
var Mt2 = Object.freeze({ __proto__: null, base36: zt, base36upper: jt });
...
var kt2 = d({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var Jt = d({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var Xt2 = d({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
...
var Ht = Object.freeze({ __proto__: null, base64: kt2, base64pad: Jt, base64url: Xt2, base64urlpad: Gt });
...
var Qt = ne.reduce((r, t, e2) => (r[t.codePointAt(0)] = e2, r), []);
function Zt(r) {
...
var fe = { ...yt, ...Ct, ...vt, ..._t, ...Ft, ...Bt, ...Mt2, ...Vt, ...Ht, ...tr };
({ ...vr, ...Rr });
...
var Br = class extends G {
  constructor(t) {
    super(t), this.initialized = false, this.name = "authEngine", this.init = () => {
      ...
      const m2 = await this.sendRequest(p2, "wc_authRequest", { payloadParams: { type: c != null ? c : "eip4361", chainId: n, statement: s, aud: o2, domain: u2, version: "1", nonce: a, iat: new Date().toISOString(), exp: h, nbf: f2 }, requester: { publicKey: D4, metadata: this.client.metadata } }, {}, e2.expiry);
      ...
      const s = n.requester.publicKey, o2 = await this.client.core.crypto.generateKeyPair(), u2 = Kn(s), a = { type: _, receiverPublicKey: s, senderPublicKey: o2 };
      if ("error" in e2) {
        await this.sendError(n.id, u2, e2, a);
        return;
      }
      const c = { h: { t: "eip4361" }, p: V2(I({}, n.cacaoPayload), { iss: i2 }), s: e2.signature };
...
${e2.resources.map((D4) => `- ${D4}`).join(`
`)}` : void 0;
      return [n, s, "", o2, "", u2, a, c, h, f2, p2, A].filter((D4) => D4 != null).join(`
`);
      ...
      if (o2 && (c.ttl = o2), this.client.core.history.set(e2, u2), D()) {
        const h = K(JSON.stringify(u2));
        this.client.core.verify.register({ attestationId: h });
      }
      return await this.client.core.relayer.publish(e2, a, V2(I({}, c), { internal: { throwOnFailedPublish: true } })), u2.id;
      ...
      return await this.client.core.relayer.publish(i2, u2, V2(I({}, c), { internal: { throwOnFailedPublish: true } })), await this.client.core.history.resolve(o2), o2.id;
...
var S = class extends H {
  constructor(t) {
    super(t), this.protocol = $, this.version = Q, this.name = B, this.events = new import_events.EventEmitter(), this.emit = (i2, n) => this.events.emit(i2, n), this.on = (i2, n) => this.events.on(i2, n), this.once = (i2, n) => this.events.once(i2, n), this.off = (i2, n) => this.events.off(i2, n), this.removeListener = (i2, n) => this.events.removeListener(i2, n), this.request = async (i2, n) => {
      try {
    ...
    this.name = (t == null ? void 0 : t.name) || B, this.metadata = t.metadata, this.projectId = t.projectId, this.core = t.core || new Nr(t), this.logger = (0, import_logger.generateChildLogger)(e2, this.name), this.authKeys = new Mt(this.core, this.logger, "authKeys", F, () => x), this.pairingTopics = new Mt(this.core, this.logger, "pairingTopics", F), this.requests = new Mt(this.core, this.logger, "requests", F, (i2) => i2.id), this.engine = new Br(this);
  }
  static async init(t) {
    const e2 = new S(t);
...
var p = class extends x2 {
  constructor(t) {
    ...
    }, this.metadata = t.metadata, this.name = t.name || d2, this.core = t.core, this.logger = this.core.logger, this.engine = new D3(this);
  }
  static async init(t) {
    const e2 = new p(t);
    return await e2.initialize(), e2;
...
var WalletConnectV2Handler = class extends WalletConnectHandler {
  constructor(options) {
    ...
    _classPrivateFieldSet(this, _core, new Nr({
...
var SmartWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-Q3RWPTTI.js");
...
var PaperWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-JWMVZREE.js");
...
var BloctoWallet = class extends AbstractClientWallet {
  ...
  async initConnector() {
    ...
    const {
      BloctoConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-UTCDA64T.js");
...
var CoinbaseWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-RKJSJ47B.js");
...
// node_modules/@thirdweb-dev/wallets/dist/embedded-wallet-82928b32.browser.esm.js
init_shim();
init_lib3();
...
var FrameWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        FrameConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-frame.browser.esm-J3ECL6WG.js");
...
var InjectedWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-ZHZZMHGR.js");
...
var LocalWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-SPCBXVD2.js");
...
var SignerWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SignerConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-signer.browser.esm-JBIHFTZG.js");
      if (!this.signer) {
...
var MagicLink = class extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-B4J7DQ6G.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-YGFS4P2Q.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-ZOSCQF2H.js");
...
var PhantomWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        PhantomConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-phantom.browser.esm-JNAHA624.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RainbowConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rainbow.browser.esm-L7HJGTTJ.js");
...
var SafeWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-ZH5DCNYF.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          TrustConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-trust.browser.esm-4INBYJXX.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ZerionConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-zerion.browser.esm-IXMIM652.js");
...
//# sourceMappingURL=chunk-DRCJTDBG.js.map
