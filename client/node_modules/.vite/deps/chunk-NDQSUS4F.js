...
} from "./chunk-DRCJTDBG.js";
import {
  detect
} from "./chunk-6O6QX55D.js";
import {
  assertWindowEthereum
} from "./chunk-BL3IWORX.js";
import {
  walletIds
} from "./chunk-TYXDGSXI.js";
import {
  require_react_dom
} from "./chunk-D5QSMFNC.js";
import {
  require_jsx_runtime
...
import {
  ...
  watchTransactions
} from "./chunk-OZW2TMD3.js";
import {
  ListingType
} from "./chunk-ZXLXPU3N.js";
import {
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (import_process.default.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState7 = React15.useState, useEffect8 = React15.useEffect, useLayoutEffect2 = React15.useLayoutEffect, useDebugValue = React15.useDebugValue;
...
var StyleSheet = function() {
  function StyleSheet2(options) {
    ...
    this.isSpeedy = options.speedy === void 0 ? import_process.default.env.NODE_ENV === "production" : options.speedy;
    this.tags = [];
    this.ctr = 0;
  ...
  _proto.insert = function insert(rule) {
    ...
    if (this.isSpeedy) {
      ...
      try {
        ...
        if (import_process.default.env.NODE_ENV !== "production" && !/:(-moz-placeholder|-moz-focus-inner|-moz-focusring|-ms-input-placeholder|-moz-read-write|-moz-read-only|-ms-clear|-ms-expand|-ms-reveal){/.test(rule)) {
...
var createCache = function createCache2(options) {
  var key = options.key;
  if (import_process.default.env.NODE_ENV !== "production" && !key) {
  ...
  {
    var currentSheet;
    var finalizingPlugins = [stringify, import_process.default.env.NODE_ENV !== "production" ? function(element) {
      if (!element.root) {
        if (element["return"]) {
    ...
    _insert = function insert(selector, serialized, sheet, shouldCache) {
      currentSheet = sheet;
      if (import_process.default.env.NODE_ENV !== "production" && serialized.map !== void 0) {
        currentSheet = {
...
function handleInterpolation(mergedProps, registered, interpolation) {
  ...
  if (interpolation.__emotion_styles !== void 0) {
    if (import_process.default.env.NODE_ENV !== "production" && interpolation.toString() === "NO_COMPONENT_SELECTOR") {
  ...
  switch (typeof interpolation) {
    ...
    case "object": {
      ...
      if (interpolation.styles !== void 0) {
        ...
        if (import_process.default.env.NODE_ENV !== "production" && interpolation.map !== void 0) {
  ...
  if (Array.isArray(obj)) {
    ...
    for (var _key in obj) {
      ...
      if (typeof value !== "object") {
        ...
        if (_key === "NO_COMPONENT_SELECTOR" && import_process.default.env.NODE_ENV !== "production") {
          throw new Error(noComponentSelectorMessage);
        }
        if (Array.isArray(value) && typeof value[0] === "string" && (registered == null || registered[value[0]] === void 0)) {
          ...
          switch (_key) {
            ...
            default: {
              if (import_process.default.env.NODE_ENV !== "production" && _key === "undefined") {
...
var serializeStyles = function serializeStyles2(args, registered, mergedProps) {
  ...
  if (strings == null || strings.raw === void 0) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && strings[0] === void 0) {
  ...
  for (var i = 1; i < args.length; i++) {
    ...
    if (stringMode) {
      if (import_process.default.env.NODE_ENV !== "production" && strings[i] === void 0) {
        console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR);
      }
      styles += strings[i];
    }
...
var getTheme = function getTheme2(outerTheme, theme) {
  if (typeof theme === "function") {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && (mergedTheme == null || typeof mergedTheme !== "object" || Array.isArray(mergedTheme))) {
      throw new Error("[ThemeProvider] Please return an object from your theme function, i.e. theme={() => ({})}!");
    }
    return mergedTheme;
  }
  if (import_process.default.env.NODE_ENV !== "production" && (theme == null || typeof theme !== "object" || Array.isArray(theme))) {
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && serialized.name.indexOf("-") === -1) {
  ...
  for (var key in props) {
    if (hasOwnProperty.call(props, key) && key !== "css" && key !== typePropName && (import_process.default.env.NODE_ENV === "production" || key !== labelPropName)) {
...
var Global = withEmotionCache(function(props, cache) {
  if (import_process.default.env.NODE_ENV !== "production" && !warnedAboutCssPropForGlobal && (props.className || props.css)) {
    ...
    switch (typeof arg) {
      ...
      case "object": {
        if (Array.isArray(arg)) {
          ...
          if (import_process.default.env.NODE_ENV !== "production" && arg.styles !== void 0 && arg.name !== void 0) {
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  var css2 = function css3() {
    if (hasRendered && import_process.default.env.NODE_ENV !== "production") {
...
if (import_process.default.env.NODE_ENV !== "production") {
  ...
  if (isBrowser3 && !isTestEnv) {
    globalContext = typeof globalThis !== "undefined" ? globalThis : isBrowser3 ? window : _global;
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    if (args[0] == null || args[0].raw === void 0) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && args[0][0] === void 0) {
      ...
      var i = 1;
      for (; i < len; i++) {
        if (import_process.default.env.NODE_ENV !== "production" && args[0][i] === void 0) {
          console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR2);
        }
    ...
    Object.defineProperty(Styled, "toString", {
      value: function value() {
        if (targetClassName === void 0 && import_process.default.env.NODE_ENV !== "production") {
...
var _excluded = ["color"];
var AccessibilityIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ActivityLogIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignBaselineIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignBottomIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignCenterHorizontallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignCenterVerticallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AlignTopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AllSidesIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AngleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArchiveIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowBottomLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowBottomRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowDownIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowTopLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowTopRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ArrowUpIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AspectRatioIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var AvatarIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BackpackIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BadgeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BarChartIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BellIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BlendingModeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BookmarkIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BookmarkFilledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderAllIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderBottomIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderDashedIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderDottedIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var BorderRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$A = ["color"];
var BorderSolidIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$A);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$B = ["color"];
var BorderSplitIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$B);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$C = ["color"];
var BorderStyleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$C);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$D = ["color"];
var BorderTopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$D);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$E = ["color"];
var BorderWidthIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$E);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$F = ["color"];
var BoxIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$F);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$G = ["color"];
var BoxModelIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$G);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$H = ["color"];
var ButtonIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$H);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$I = ["color"];
var CalendarIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$I);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$J = ["color"];
var CameraIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$J);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$K = ["color"];
var CardStackIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$K);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$L = ["color"];
var CardStackMinusIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$L);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$M = ["color"];
var CardStackPlusIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$M);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$N = ["color"];
var CaretDownIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$N);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$O = ["color"];
var CaretLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$O);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$P = ["color"];
var CaretRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$P);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$Q = ["color"];
var CaretSortIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$Q);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$R = ["color"];
var CaretUpIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$R);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$S = ["color"];
var ChatBubbleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$S);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$T = ["color"];
var CheckIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$T);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$U = ["color"];
var CheckCircledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$U);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$V = ["color"];
var CheckboxIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$V);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$W = ["color"];
var ChevronDownIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$W);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$X = ["color"];
var ChevronLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$X);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$Y = ["color"];
var ChevronRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$Y);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$Z = ["color"];
var ChevronUpIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$Z);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var CircleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$$ = ["color"];
var CircleBackslashIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$$);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var ClipboardIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ClipboardCopyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ClockIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CodeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CodeSandboxLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ColorWheelIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ColumnSpacingIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ColumnsIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CommitIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Component1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Component2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ComponentBooleanIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ComponentInstanceIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ComponentNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ComponentPlaceholderIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ContainerIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CookieIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CopyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CornerBottomLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CornerBottomRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CornerTopLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CornerTopRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CornersIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CountdownTimerIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CounterClockwiseClockIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CropIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Cross1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Cross2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CrossCircledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Crosshair1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Crosshair2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CrumpledPaperIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CubeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CursorArrowIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var CursorTextIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var DashIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$1A = ["color"];
var DashboardIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1A);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1B = ["color"];
var DesktopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1B);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1C = ["color"];
var DimensionsIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1C);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1D = ["color"];
var DiscIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1D);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1E = ["color"];
var DiscordLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1E);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1F = ["color"];
var DividerHorizontalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1F);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1G = ["color"];
var DividerVerticalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1G);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1H = ["color"];
var DotIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1H);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1I = ["color"];
var DotFilledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1I);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1J = ["color"];
var DotsHorizontalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1J);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1K = ["color"];
var DotsVerticalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1K);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1L = ["color"];
var DoubleArrowDownIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1L);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1M = ["color"];
var DoubleArrowLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1M);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1N = ["color"];
var DoubleArrowRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1N);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1O = ["color"];
var DoubleArrowUpIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1O);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1P = ["color"];
var DownloadIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1P);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1Q = ["color"];
var DragHandleDots1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1Q);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1R = ["color"];
var DragHandleDots2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1R);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1S = ["color"];
var DragHandleHorizontalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1S);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1T = ["color"];
var DragHandleVerticalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1T);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1U = ["color"];
var DrawingPinIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1U);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1V = ["color"];
var DrawingPinFilledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1V);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1W = ["color"];
var DropdownMenuIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1W);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1X = ["color"];
var EnterIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1X);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1Y = ["color"];
var EnterFullScreenIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1Y);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$1Z = ["color"];
var EnvelopeClosedIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1Z);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var EnvelopeOpenIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$1$ = ["color"];
var EraserIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1$);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var ExclamationTriangleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ExitIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ExitFullScreenIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ExternalLinkIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var EyeClosedIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var EyeNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var EyeOpenIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FaceIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FigmaLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FileIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FileMinusIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FilePlusIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FileTextIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FontBoldIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FontFamilyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FontItalicIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FontRomanIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FontSizeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FontStyleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FrameIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var FramerLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var GearIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var GitHubLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var GlobeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var GridIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var GroupIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Half1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Half2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HamburgerMenuIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HandIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HeadingIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HeartIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HeartFilledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HeightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HobbyKnifeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var HomeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$2A = ["color"];
var IconJarLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2A);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2B = ["color"];
var IdCardIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2B);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2C = ["color"];
var ImageIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2C);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2D = ["color"];
var InfoCircledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2D);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2E = ["color"];
var InputIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2E);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2F = ["color"];
var InstagramLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2F);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2G = ["color"];
var KeyboardIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2G);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2H = ["color"];
var LapTimerIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2H);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2I = ["color"];
var LaptopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2I);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2J = ["color"];
var LayersIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2J);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2K = ["color"];
var LayoutIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2K);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2L = ["color"];
var LetterCaseCapitalizeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2L);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2M = ["color"];
var LetterCaseLowercaseIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2M);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2N = ["color"];
var LetterCaseToggleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2N);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2O = ["color"];
var LetterCaseUppercaseIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2O);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2P = ["color"];
var LetterSpacingIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2P);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2Q = ["color"];
var LightningBoltIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2Q);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2R = ["color"];
var LineHeightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2R);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2S = ["color"];
var Link1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2S);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2T = ["color"];
var Link2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2T);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2U = ["color"];
var LinkBreak1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2U);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2V = ["color"];
var LinkBreak2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2V);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2W = ["color"];
var LinkNone1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2W);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2X = ["color"];
var LinkNone2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2X);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2Y = ["color"];
var LinkedInLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2Y);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$2Z = ["color"];
var ListBulletIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2Z);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var LockClosedIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$2$ = ["color"];
var LockOpen1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$2$);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var LockOpen2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var LoopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MagicWandIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MagnifyingGlassIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MarginIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MaskOffIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MaskOnIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MinusIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MinusCircledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MixIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MixerHorizontalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MixerVerticalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MobileIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ModulzLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MoonIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var MoveIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var NotionLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var OpacityIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var OpenInNewWindowIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var OverlineIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PaddingIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PaperPlaneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PauseIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Pencil1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var Pencil2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PersonIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PieChartIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PilcrowIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PinBottomIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PinLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PinRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PinTopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PlayIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PlusIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var PlusCircledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var QuestionMarkIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$3A = ["color"];
var QuestionMarkCircledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3A);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3B = ["color"];
var QuoteIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3B);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3C = ["color"];
var RadiobuttonIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3C);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3D = ["color"];
var ReaderIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3D);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3E = ["color"];
var ReloadIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3E);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3F = ["color"];
var ResetIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3F);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3G = ["color"];
var ResumeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3G);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3H = ["color"];
var RocketIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3H);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3I = ["color"];
var RotateCounterClockwiseIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3I);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3J = ["color"];
var RowSpacingIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3J);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3K = ["color"];
var RowsIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3K);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3L = ["color"];
var RulerHorizontalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3L);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3M = ["color"];
var RulerSquareIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3M);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3N = ["color"];
var ScissorsIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3N);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3O = ["color"];
var SectionIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3O);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3P = ["color"];
var SewingPinIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3P);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3Q = ["color"];
var SewingPinFilledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3Q);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3R = ["color"];
var ShadowIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3R);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3S = ["color"];
var ShadowInnerIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3S);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3T = ["color"];
var ShadowNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3T);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3U = ["color"];
var ShadowOuterIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3U);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3V = ["color"];
var Share1Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3V);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3W = ["color"];
var Share2Icon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3W);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3X = ["color"];
var ShuffleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3X);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3Y = ["color"];
var SizeIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3Y);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$3Z = ["color"];
var SketchLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3Z);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var SlashIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$3$ = ["color"];
var SliderIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$3$);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var SpaceBetweenHorizontallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpaceBetweenVerticallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpaceEvenlyHorizontallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpaceEvenlyVerticallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpeakerLoudIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpeakerModerateIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpeakerOffIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SpeakerQuietIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SquareIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StackIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StarIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StarFilledIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StitchesLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StopwatchIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StretchHorizontallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StretchVerticallyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var StrikethroughIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SunIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SwitchIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var SymbolIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TableIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TargetIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignBottomIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignCenterIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignJustifyIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignMiddleIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextAlignTopIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var TextNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ThickArrowDownIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ThickArrowLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ThickArrowRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var ThickArrowUpIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
...
var _excluded$4A = ["color"];
var TimerIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4A);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4B = ["color"];
var TokensIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4B);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4C = ["color"];
var TrackNextIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4C);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4D = ["color"];
var TrackPreviousIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4D);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4E = ["color"];
var TransformIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4E);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4F = ["color"];
var TransparencyGridIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4F);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4G = ["color"];
var TrashIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4G);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4H = ["color"];
var TriangleDownIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4H);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4I = ["color"];
var TriangleLeftIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4I);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4J = ["color"];
var TriangleRightIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4J);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4K = ["color"];
var TriangleUpIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4K);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4L = ["color"];
var TwitterLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4L);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4M = ["color"];
var UnderlineIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4M);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4N = ["color"];
var UpdateIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4N);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4O = ["color"];
var UploadIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4O);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4P = ["color"];
var ValueIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4P);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4Q = ["color"];
var ValueNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4Q);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4R = ["color"];
var VercelLogoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4R);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4S = ["color"];
var VideoIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4S);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4T = ["color"];
var ViewGridIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4T);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4U = ["color"];
var ViewHorizontalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4U);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4V = ["color"];
var ViewNoneIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4V);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4W = ["color"];
var ViewVerticalIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4W);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4X = ["color"];
var WidthIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4X);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4Y = ["color"];
var ZoomInIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4Y);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var _excluded$4Z = ["color"];
var ZoomOutIcon = (0, import_react5.forwardRef)(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$4Z);
  return (0, import_react5.createElement)("svg", Object.assign({
    width: "15",
    height: "15",
...
var QueryClient = class {
  constructor(config = {}) {
    ...
    this.mountCount = 0;
    if (import_process.default.env.NODE_ENV !== "production" && config.logger) {
...
var QueryObserver = class extends Subscribable {
  ...
  setOptions(options, notifyOptions) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && typeof (options == null ? void 0 : options.isDataEqual) !== "undefined") {
...
init_shim();
var import_shim49 = __toESM(require_shim());
"use client";
var useSyncExternalStore = import_shim49.useSyncExternalStore;

// node_modules/@tanstack/react-query/build/lib/QueryClientProvider.esm.js
init_shim();
var React5 = __toESM(require_react());
"use client";
var defaultContext = React5.createContext(void 0);
var QueryClientSharingContext = React5.createContext(false);
...
var useQueryClient = ({
  ...
  const queryClient = React5.useContext(getQueryClientContext(context, React5.useContext(QueryClientSharingContext)));
  if (!queryClient) {
...
var QueryClientProvider = ({
  ...
  if (import_process.default.env.NODE_ENV !== "production" && contextSharing) {
    client.getLogger().error("The contextSharing option has been deprecated and will be removed in the next major version");
  }
  const Context = getQueryClientContext(context, contextSharing);
  return React5.createElement(QueryClientSharingContext.Provider, {
...
function useBaseQuery(options, Observer) {
  ...
  const [observer] = React10.useState(() => new Observer(queryClient, defaultedOptions));
  const result = observer.getOptimisticResult(defaultedOptions);
  useSyncExternalStore(React10.useCallback((onStoreChange) => {
...
function useMutation(arg1, arg2, arg3) {
  ...
  const [observer] = React14.useState(() => new MutationObserver(queryClient, options));
  React14.useEffect(() => {
    observer.setOptions(options);
  }, [observer, options]);
  const result = useSyncExternalStore(React14.useCallback((onStoreChange) => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  const mutate = React14.useCallback((variables, mutateOptions) => {
...
// node_modules/@thirdweb-dev/react-core/dist/required-param-d1f74675.browser.esm.js
init_shim();
...
var QueryClientProviderWithDefault = (_ref) => {
  ...
  const queryClientWithDefault = (0, import_react6.useMemo)(() => {
...
// node_modules/@thirdweb-dev/react-core/dist/useTransactions-961e942c.browser.esm.js
init_shim();
var import_lite = __toESM(require_lite());

// node_modules/@thirdweb-dev/auth/dist/thirdweb-dev-auth.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/auth/dist/auth-05a8826c.browser.esm.js
init_shim();
init_lib();
...
var AccountTypeSchema = z.union([z.literal("evm"), z.literal("solana")]);
var AuthenticationPayloadDataSchema = z.object({
  ...
  nbf: RawDateSchema,
  iat: RawDateSchema,
  jti: z.string().default(v4_default()),
  ctx: JsonSchema.optional()
});
var AuthenticationPayloadSchema = z.object({
  payload: AuthenticationPayloadDataSchema,
  signature: z.string()
});
var AuthenticateOptionsSchema = z.object({
  domain: z.string(),
...
var THIRDWEB_AUTH_COOKIE_PREFIX = `thirdweb_auth`;
var THIRDWEB_AUTH_TOKEN_COOKIE_PREFIX = `${THIRDWEB_AUTH_COOKIE_PREFIX}_token`;
var THIRDWEB_AUTH_ACTIVE_ACCOUNT_COOKIE = `${THIRDWEB_AUTH_COOKIE_PREFIX}_active_account`;
var THIRDWEB_AUTH_DEFAULT_LOGIN_PAYLOAD_DURATION_IN_SECONDS = 60 * 10;
var THIRDWEB_AUTH_DEFAULT_TOKEN_DURATION_IN_SECONDS = 60 * 60 * 24;
var GenerateOptionsSchema = z.object({
  domain: z.string(),
  tokenId: z.string().optional(),
  expirationTime: z.date().default(() => new Date(Date.now() + 1e3 * THIRDWEB_AUTH_DEFAULT_TOKEN_DURATION_IN_SECONDS)),
...
var RefreshOptionsSchema = z.object({
  expirationTime: z.date().default(() => new Date(Date.now() + 1e3 * THIRDWEB_AUTH_DEFAULT_TOKEN_DURATION_IN_SECONDS))
});
var LoginOptionsSchema = z.object({
  ...
  expirationTime: z.date().default(() => new Date(Date.now() + 1e3 * THIRDWEB_AUTH_DEFAULT_LOGIN_PAYLOAD_DURATION_IN_SECONDS)),
  invalidBefore: z.date().default(() => new Date(Date.now() - 1e3 * THIRDWEB_AUTH_DEFAULT_LOGIN_PAYLOAD_DURATION_IN_SECONDS)),
  resources: z.array(z.string()).optional()
});
var LoginPayloadDataSchema = z.object({
  ...
  nonce: z.string().default(v4_default()),
...
var LoginPayloadOutputSchema = LoginPayloadSchema.extend({
...
function createLoginMessage(payload) {
  ...
  let prefix3 = [header, payload.address].join("\n");
  prefix3 = [prefix3, payload.statement].join("\n\n");
...
async function buildLoginPayload(_ref) {
  ...
  let chainId = parsedOptions == null ? void 0 : parsedOptions.chainId;
  ...
  return LoginPayloadDataSchema.parse({
    ...
    address: (parsedOptions == null ? void 0 : parsedOptions.address) || await wallet.getAddress(),
    statement: parsedOptions == null ? void 0 : parsedOptions.statement,
    version: parsedOptions == null ? void 0 : parsedOptions.version,
    uri: parsedOptions == null ? void 0 : parsedOptions.uri,
    chain_id: chainId,
    ...
    resources: parsedOptions == null ? void 0 : parsedOptions.resources
  });
}
...
async function verifyLoginPayload(_ref4) {
  ...
  if (parsedOptions == null ? void 0 : parsedOptions.statement) {
  ...
  if (parsedOptions == null ? void 0 : parsedOptions.uri) {
  ...
  if (parsedOptions == null ? void 0 : parsedOptions.version) {
  ...
  if (parsedOptions == null ? void 0 : parsedOptions.chainId) {
  ...
  if ((parsedOptions == null ? void 0 : parsedOptions.validateNonce) !== void 0) {
    try {
  ...
  if (parsedOptions == null ? void 0 : parsedOptions.resources) {
    const missingResources = parsedOptions.resources.filter((resource) => {
      var _a;
      return !((_a = payload.payload.resources) == null ? void 0 : _a.includes(resource));
    });
  ...
  const chainId = wallet.type === "evm" && payload.payload.chain_id ? parseInt(payload.payload.chain_id) : void 0;
...
async function generateJWT(_ref2) {
  ...
  let session = void 0;
  if (typeof (parsedOptions == null ? void 0 : parsedOptions.session) === "function") {
    const sessionTrigger = await parsedOptions.session(userAddress);
    if (sessionTrigger) {
      session = sessionTrigger;
    }
  } else {
    session = parsedOptions == null ? void 0 : parsedOptions.session;
  }
  ...
  return buildJWT({
    ...
    payload: {
      ...
      iat: new Date(),
      jti: parsedOptions == null ? void 0 : parsedOptions.tokenId,
      ctx: session
    }
  });
}
...
async function authenticateJWT(_ref4) {
  ...
  if ((parsedOptions == null ? void 0 : parsedOptions.validateTokenId) !== void 0) {
    try {
...
var ThirdwebAuth = class {
  ...
  formatOptions(options) {
    return options ? {
      ...options,
      domain: (options == null ? void 0 : options.domain) || this.domain
    } : {
      domain: this.domain
    };
  }
...
// node_modules/@thirdweb-dev/sdk/evm/dist/thirdweb-dev-sdk-evm.browser.esm.js
init_shim();
...
// node_modules/@thirdweb-dev/sdk/evm/functions/dist/thirdweb-dev-sdk-evm-functions.browser.esm.js
init_shim();
init_lib();
var import_bn2 = __toESM(require_bn());
var import_fast_deep_equal2 = __toESM(require_fast_deep_equal());
var import_merkletreejs2 = __toESM(require_dist());
...
var ThirdwebThemeContext = (0, import_react7.createContext)(void 0);
var ThirdwebAuthContext = (0, import_react7.createContext)(void 0);
function useThirdwebAuthContext() {
  return (0, import_react7.useContext)(ThirdwebAuthContext);
}
var LAST_CONNECTED_WALLET_STORAGE_KEY = "lastConnectedWallet";
var lastConnectedWalletStorage;
var walletInstanceToConfig = /* @__PURE__ */ new Map();
var ThirdwebWalletContext = (0, import_react7.createContext)(void 0);
function ThirdwebWalletProvider(props) {
  const [signer, setSigner] = (0, import_react7.useState)(void 0);
  const [connectionStatus, setConnectionStatus] = (0, import_react7.useState)("unknown");
  const autoConnectTimeout = props.autoConnectTimeout || 15e3;
  const [activeWallet, setActiveWallet] = (0, import_react7.useState)();
  const [createdWalletInstance, setCreatedWalletInstance] = (0, import_react7.useState)();
  const [activeWalletConfig, setActiveWalletConfig] = (0, import_react7.useState)();
  ...
  const walletParams = (0, import_react7.useMemo)(() => {
    return {
      chains: props.chains,
  ...
  const createWalletInstance = (0, import_react7.useCallback)((walletConfig) => {
  ...
  const setConnectedWallet = (0, import_react7.useCallback)(async function(wallet, connectParams) {
  ...
  const storeLastActiveChainId = (0, import_react7.useCallback)(async (chainId) => {
  ...
  const switchChain = (0, import_react7.useCallback)(async (chainId) => {
    if (!activeWallet) {
  ...
  const autoConnectTriggered = (0, import_react7.useRef)(false);
  (0, import_react7.useEffect)(() => {
    ...
    async function autoconnect() {
      ...
      const personalWalletInfo = (_a = walletInfo.connectParams) == null ? void 0 : _a.personalWallet;
  ...
  const connectWallet = (0, import_react7.useCallback)(async function() {
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
  ...
  const onWalletDisconnect = (0, import_react7.useCallback)(async () => {
  ...
  const disconnectWallet = (0, import_react7.useCallback)(async () => {
    if (!activeWallet) {
      onWalletDisconnect();
      return;
    }
    ...
    if (personalWallet) {
      await (personalWallet == null ? void 0 : personalWallet.disconnect());
    }
    onWalletDisconnect();
  ...
  const signerConnected = (0, import_react7.useRef)();
  (0, import_react7.useEffect)(() => {
    if (!props.signerWallet) {
      if (signerConnected.current) {
        disconnectWallet();
        signerConnected.current = void 0;
      }
      return;
    }
  ...
  return (0, import_jsx_runtime2.jsx)(ThirdwebWalletContext.Provider, {
    value: {
...
function useWalletContext() {
  const ctx = (0, import_react7.useContext)(ThirdwebWalletContext);
  if (!ctx) {
...
var autoConnectTimeoutErrorMessage = `Failed to Auto connect. Auto connect timed out. You can increase the timeout duration using the autoConnectTimeout prop on <ThirdwebProvider />`;
...
function createContractCacheKey() {
  let contractAddress = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : lib_exports.AddressZero;
...
var AUTH_TOKEN_STORAGE_KEY = "auth_token_storage_key";
function useLogin() {
  const queryClient = useQueryClient();
  ...
  const login = useMutation({
    mutationFn: async () => {
      ...
      await ((_a = authConfig.secureStorage) == null ? void 0 : _a.setItem(AUTH_TOKEN_STORAGE_KEY, token2));
...
function useLogout() {
  ...
  const logout = useMutation({
    mutationFn: async () => {
      ...
      (_a = authConfig.secureStorage) == null ? void 0 : _a.removeItem(AUTH_TOKEN_STORAGE_KEY);
      queryClient.invalidateQueries(cacheKeys.auth.user());
    }
  });
  return {
...
function useUser() {
  ...
  const {
    ...
    invariant(authConfig, "Please specify an authConfig in the ThirdwebProvider");
    invariant(authConfig.authUrl, "Please specify an authUrl in the authConfig.");
    const token2 = await ((_a = authConfig.secureStorage) == null ? void 0 : _a.getItem(AUTH_TOKEN_STORAGE_KEY));
    const params = {
      credentials: "include",
      ...token2 ? {
        headers: {
...
function useAuth() {
  ...
  return (0, import_react7.useMemo)(() => {
    if (!(authConfig == null ? void 0 : authConfig.domain)) {
      return void 0;
    }
    if (!wallet) {
      return void 0;
  ...
  }, [wallet, authConfig == null ? void 0 : authConfig.domain]);
}
var ThirdwebAuthProvider = (_ref) => {
  let {
    value,
    children
  } = _ref;
  const authContext = (0, import_react7.useMemo)(() => {
    var _a;
    if (!value) {
      return void 0;
    }
    const context = {
      ...value,
      authUrl: (_a = value.authUrl) == null ? void 0 : _a.replace(/\/$/, "")
    };
    return context;
  }, [value]);
  return (0, import_jsx_runtime2.jsxs)(ThirdwebAuthContext.Provider, {
    value: authContext,
    children: [children, (0, import_jsx_runtime2.jsx)(ChangeActiveWalletOnAccountSwitch, {})]
  });
};
...
function useUpdateChainsWithClientId(supportedChains, activeChain, clientId) {
  const supportedChainsWithKey = (0, import_react7.useMemo)(() => {
    return supportedChains.map((chain) => updateChainRPCs(chain, clientId));
  }, [supportedChains, clientId]);
  const activeChainIdOrObjWithKey = (0, import_react7.useMemo)(() => {
...
var ThirdwebConfigContext = (0, import_react7.createContext)(void 0);
...
function useThirdwebConfigContext() {
  const context = (0, import_react7.useContext)(ThirdwebConfigContext);
  invariant(context, "useThirdwebConfigContext() hook must be used within a <ThirdwebProvider/>");
  return context;
}
var ThirdwebSDKContext = (0, import_react7.createContext)({});
var __DEV__ = import_process.default.env.NODE_ENV !== "production";
function useSDKContext() {
  const ctx = (0, import_react7.useContext)(ThirdwebSDKContext);
...
var ThirdwebConnectedWalletContext = (0, import_react7.createContext)(void 0);
var ThirdwebConnectedWalletProvider = (_ref) => {
  ...
  const storage = (_a = useSDK()) == null ? void 0 : _a.storage;
  const [contextValue, setContextValue] = (0, import_react7.useState)({
...
function useThirdwebConnectedWalletContext() {
  const context = (0, import_react7.useContext)(ThirdwebConnectedWalletContext);
...
var WrappedThirdwebSDKProvider = (_ref) => {
  ...
  const activeChainId = (0, import_react7.useMemo)(() => {
    var _a, _b;
    if (!activeChain) {
      return (_a = supportedChains[0]) == null ? void 0 : _a.chainId;
    }
    if (typeof activeChain === "number") {
      return activeChain;
    }
    if (typeof activeChain === "string") {
      return (_b = supportedChains.find((c) => c.slug === activeChain)) == null ? void 0 : _b.chainId;
    }
    return activeChain.chainId;
  }, [activeChain, supportedChains]);
  const sdk = (0, import_react7.useMemo)(() => {
  ...
  }, [sdk, sdk == null ? void 0 : sdk._chainId, signer, activeChainId]);
  const ctxValue = (0, import_react7.useMemo)(() => ({
    sdk: sdk && sdk._chainId === activeChainId ? sdk : void 0,
    _inProvider: true
  }), [activeChainId, sdk]);
  return (0, import_jsx_runtime2.jsx)(ThirdwebSDKContext.Provider, {
    value: ctxValue,
    children
  });
};
var ThirdwebSDKProvider = (_ref2) => {
  ...
  if (!clientId) {
    checkClientIdOrSecretKey("No API key. Please provide a clientId. It is required to access thirdweb's services. You can create a key at https://thirdweb.com/create-api-key", clientId, void 0);
  }
  const supportedChains = _supportedChains || defaultChains;
  const supportedChainsNonNull = (0, import_react7.useMemo)(() => {
  ...
  const mergedChains = (0, import_react7.useMemo)(() => {
  ...
  return (0, import_jsx_runtime2.jsx)(ThirdwebConfigProvider, {
    ...
    children: (0, import_jsx_runtime2.jsx)(QueryClientProviderWithDefault, {
      queryClient,
      children: (0, import_jsx_runtime2.jsx)(WrappedThirdwebSDKProvider, {
        ...
        ...restProps,
        children: (0, import_jsx_runtime2.jsx)(ThirdwebConnectedWalletProvider, {
          signer,
          children
        })
      })
...
var ThirdwebProviderCore = (_ref) => {
  ...
  const activeChainWithKey = (0, import_react7.useMemo)(() => {
  ...
  return (0, import_jsx_runtime2.jsx)(ThirdwebThemeContext.Provider, {
    value: props.theme,
    children: (0, import_jsx_runtime2.jsx)(ThirdwebWalletProvider, {
      ...
      children: (0, import_jsx_runtime2.jsx)(ThirdwebSDKProviderWrapper, {
        ...
        children: (0, import_jsx_runtime2.jsx)(ThirdwebAuthProvider, {
...
var ThirdwebSDKProviderWrapper = (_ref2) => {
  var _a;
  let {
    children,
    ...props
  } = _ref2;
  const signer = (_a = useWalletContext()) == null ? void 0 : _a.signer;
...
function useBalance(tokenAddress) {
  ...
  const cacheKey = (0, import_react7.useMemo)(() => {
...
function useChain() {
  ...
  const chain = (0, import_react7.useMemo)(() => {
    return chains.find((_chain) => _chain.chainId === chainId);
  }, [chainId, chains]);
  const unknownChain = (0, import_react7.useMemo)(() => {
    if (!chain) {
...
function useNetwork() {
  ...
  const switchNetwork = (0, import_react7.useCallback)(async (_chainId) => {
    setLoading(true);
    setError(void 0);
    try {
...
function useActiveClaimConditionForWallet(contract, walletAddress, tokenId) {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.useActiveClaimConditionForWallet(contractAddress, walletAddress || "_NO_WALLET_", tokenId), async () => {
    ...
    const normalizedPrize = price ? price === "unlimited" ? lib_exports.MaxUint256 : utils_exports.parseUnits(price, currencyMetadata.decimals) : null;
...
function useContractEvents(contract, eventName) {
  ...
  const queryClient = useQueryClient();
  const activeChainId = useSDKChainId();
  const cacheKey = (0, import_react7.useMemo)(() => createCacheKeyWithNetwork(eventName ? cacheKeys.contract.events.getEvents(contractAddress, eventName) : cacheKeys.contract.events.getAllEvents(contractAddress), activeChainId), [activeChainId, contractAddress, eventName]);
  (0, import_react7.useEffect)(() => {
...
function useEnglishAuctionWinningBid(contract, auctionId) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.marketplace.englishAuctions.getWinningBid(contractAddress, auctionId), () => {
    ...
    enabled: !!contract && auctionId !== void 0
  });
}
...
function isMarketplaceV1(contract) {
  return contract.getAllListings !== void 0;
}
...
function useIsAddressRole(contract, role, walletAddress) {
  ...
  if (data == null ? void 0 : data.includes(lib_exports.AddressZero)) {
    return true;
  }
...
function useTransferBatchToken(contract) {
  ...
  return useMutation((data) => {
    if (erc20) {
      ...
      const convertedData = data.map((token2) => ({
        toAddress: token2.to,
...
function useSupportedWallet(id) {
  const context = useWalletContext();
  const wallet = context == null ? void 0 : context.wallets.find((_wallet) => _wallet.id === id);
  if (!wallet) {
...
function useAppURI(contract) {
  return useQueryWithNetwork(cacheKeys.contract.app.get(contract == null ? void 0 : contract.getAddress()), async () => {
    requiredParamInvariant(contract, "Contract is required");
...
function useENS() {
  ...
  return useQuery({
    queryKey: ["ens", address, ethereum == null ? void 0 : ethereum.rpc],
    cacheTime: 60 * 60 * 24 * 1e3,
    staleTime: 60 * 60 * 1e3,
    retry: false,
    enabled: !!address,
    queryFn: async () => {
      ...
      if (provider instanceof lib_exports2.JsonRpcProvider) {
...
function useWatchTransactions(watchTransactionParams) {
  const {
    ...
    network,
    sdkOptions,
    limit: paramLimit = 1e3
  } = watchTransactionParams;
  const limit = Math.min(paramLimit, 1e4);
...
// node_modules/@thirdweb-dev/react-core/dist/thirdweb-dev-react-core.browser.esm.js
init_shim();
...
// node_modules/@thirdweb-dev/react/dist/formElements-49d2196e.browser.esm.js
init_shim();
...
var darkColors = {
  ...
  primaryText: mauve$1.mauve12,
  secondaryText: mauve$1.mauve10,
  danger: tomato.tomato9,
  success: green.green8,
  overlay: "rgba(0, 0, 0, 0.7)",
  accentText: "#3385FF",
  accentBg: "hsl(216 100% 50%)",
  textOnAccent: mauve$1.mauve12
};
var lightColors = {
  base1: mauve.mauve1,
  base2: mauve.mauve3,
...
var darkThemeObj = createThemeObj(darkColors);
var lightThemeObj = createThemeObj(lightColors);
var fontSize = {
  xs: "12px",
  sm: "14px",
  md: "16px",
...
`;
var IconButton = newStyled.button`
  all: unset;
  cursor: pointer;
  display: inline-flex;
  align-items: center;
...
`;
var InputButton = newStyled.button`
  all: unset;
  display: flex;
  align-items: center;
  justify-content: center;
...
`;
var ModalDescription = newStyled.p`
  all: unset;
  display: block;
...
var BackButton = (props) => {
  return (0, import_jsx_runtime4.jsx)(IconButton, {
    ...
    type: "button",
    children: (0, import_jsx_runtime4.jsx)(ChevronLeftIcon, {
      style: {
        width: iconSize.md,
        height: iconSize.md
      }
...
var Img = (props) => {
  ...
  return (0, import_jsx_runtime4.jsx)("img", {
    width: props.width,
    height: props.height,
    src: getSrc(),
    alt: props.alt || "",
...
`;
var ScreenBottomContainer = newStyled.div`
...
function ModalHeader(props) {
  ...
  return (0, import_jsx_runtime4.jsxs)("div", {
    ...
    children: [onBack && (0, import_jsx_runtime4.jsx)(BackButton, {
      onClick: onBack,
      style: {
        position: "absolute",
        left: 0,
    ...
    }), (0, import_jsx_runtime4.jsxs)(Container, {
      flex: "row",
      gap: "xs",
      center: "both",
      children: [imgSrc && (0, import_jsx_runtime4.jsx)(Img, {
        src: imgSrc,
        width: iconSize.md,
        height: iconSize.md
      }), typeof title === "string" ? (0, import_jsx_runtime4.jsx)(ModalTitle, {
        children: title
      }) : title]
    })]
  });
...
var modalMaxWidthWide = "730px";
var defaultModalTitle = "Connect";
var widemodalMaxHeight = "550px";
var compactmodalMaxHeight = "600px";
var defaultTheme = "dark";
var WalletModalOpen = (0, import_react10.createContext)(false);
var SetWalletModalOpen = (0, import_react10.createContext)(void 0);
var ModalConfigCtx = (0, import_react10.createContext)({
  title: "",
  theme: "dark",
  data: void 0,
  modalSize: "wide"
});
var SetModalConfigCtx = (0, import_react10.createContext)(() => {
});
var WalletUIStatesProvider = (props) => {
  const [isWalletModalOpen, setIsWalletModalOpen] = (0, import_react10.useState)(false);
  const _isMobile = isMobile();
  const [modalConfig, setModalConfig] = (0, import_react10.useState)({
  ...
  return (0, import_jsx_runtime4.jsx)(WalletModalOpen.Provider, {
    value: isWalletModalOpen,
    children: (0, import_jsx_runtime4.jsx)(SetWalletModalOpen.Provider, {
      value: setIsWalletModalOpen,
      children: (0, import_jsx_runtime4.jsx)(ModalConfigCtx.Provider, {
        value: modalConfig,
        children: (0, import_jsx_runtime4.jsx)(SetModalConfigCtx.Provider, {
...
var useIsWalletModalOpen = () => {
  return (0, import_react10.useContext)(WalletModalOpen);
};
var useSetIsWalletModalOpen = () => {
  const context = (0, import_react10.useContext)(SetWalletModalOpen);
  if (context === void 0) {
...
function TOS(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(Container, {
    flex: "row",
    center: "x",
    children: (0, import_jsx_runtime4.jsxs)(Text, {
      size: "xs",
      multiline: true,
      balance: true,
      inline: true,
      ...
      children: ["By connecting, you agree to the", " ", termsOfServiceUrl && (0, import_jsx_runtime4.jsxs)(Link, {
        inline: true,
        size: "xs",
      ...
      }), bothGiven && "& ", privacyPolicyUrl && (0, import_jsx_runtime4.jsx)(Link, {
        inline: true,
        size: "xs",
...
var WalletSelector = (props) => {
  const modalConfig = (0, import_react10.useContext)(ModalConfigCtx);
  ...
  const continueAsGuest = localWalletConfig && (0, import_jsx_runtime4.jsx)(Button, {
    fullWidth: true,
  ...
  const twTitle = (0, import_jsx_runtime4.jsxs)(Container, {
    gap: "xxs",
    center: "y",
    flex: "row",
    children: [modalConfig.titleIconUrl === void 0 ? (0, import_jsx_runtime4.jsx)(Link, {
      color: "primaryText",
      ...
      children: (0, import_jsx_runtime4.jsx)(TWIcon, {
        size: iconSize.md
      })
    }) : modalConfig.titleIconUrl === "" ? null : (0, import_jsx_runtime4.jsx)(Img, {
      src: modalConfig.titleIconUrl,
      width: iconSize.md,
      height: iconSize.md
    }), (0, import_jsx_runtime4.jsxs)(ModalTitle, {
  ...
  return (0, import_jsx_runtime4.jsxs)(Container, {
    scrollY: true,
    flex: "column",
    animate: "fadein",
    fullHeight: true,
    children: [(0, import_jsx_runtime4.jsx)(Container, {
      p: "lg",
      children: isWalletGroupExpanded ? (0, import_jsx_runtime4.jsx)(ModalHeader, {
        title: twTitle,
        onBack: () => {
          setIsWalletGroupExpanded(false);
        }
      }) : twTitle
    }), (0, import_jsx_runtime4.jsx)(Container, {
      expand: true,
      scrollY: true,
      ...
      children: showGroupsUI ? (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, {
        children: isWalletGroupExpanded ? (0, import_jsx_runtime4.jsx)(WalletSelection, {
          walletConfigs: eoaWallets,
          selectWallet: handleSelect
        }) : (0, import_jsx_runtime4.jsxs)(Container, {
          px: "xs",
          children: [(0, import_jsx_runtime4.jsx)(WalletSelection, {
            walletConfigs: socialWallets,
            selectWallet: handleSelect
          }), (0, import_jsx_runtime4.jsx)(TextDivider, {
            children: (0, import_jsx_runtime4.jsx)("span", {
              children: " OR "
            })
          }), (0, import_jsx_runtime4.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime4.jsxs)(Button, {
            fullWidth: true,
            variant: "outline",
            style: {
              display: "flex",
            ...
            children: [(0, import_jsx_runtime4.jsx)(Container, {
              flex: "row",
              gap: "xxs",
              children: eoaWallets.slice(0, 2).map((w) => (0, import_jsx_runtime4.jsx)(Img, {
                width: iconSize.sm,
                height: iconSize.sm,
                src: w.meta.iconURL
              }, w.id))
            }), "Connect a wallet"]
          }), continueAsGuest ? (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
            children: [(0, import_jsx_runtime4.jsx)(Spacer, {
              y: "md"
            }), continueAsGuest, (0, import_jsx_runtime4.jsx)(Spacer, {
              y: "xl"
            })]
          }) : (0, import_jsx_runtime4.jsx)(Spacer, {
            y: "xl"
      ...
      }) : (0, import_jsx_runtime4.jsx)(WalletSelection, {
        walletConfigs: nonLocalWalletConfigs,
        selectWallet: handleSelect
      })
    }), showFooter && (0, import_jsx_runtime4.jsxs)(ScreenBottomContainer, {
      children: [showNewToWallets && (0, import_jsx_runtime4.jsxs)(Container, {
        flex: "row",
        style: {
          justifyContent: "space-between"
        },
        children: [(0, import_jsx_runtime4.jsx)(Text, {
          color: "secondaryText",
          size: "sm",
          weight: 500,
          children: "New to wallets?"
        }), (0, import_jsx_runtime4.jsx)(Link, {
          weight: 500,
          size: "sm",
          target: "_blank",
    ...
    }), showTOS && !isWalletGroupExpanded && (0, import_jsx_runtime4.jsxs)("div", {
      children: [showSeperatorLine && (0, import_jsx_runtime4.jsx)(Line, {}), (0, import_jsx_runtime4.jsx)(Container, {
        p: "md",
        style: !showSeperatorLine ? {
          paddingTop: 0
        } : void 0,
        children: isCompact && (0, import_jsx_runtime4.jsx)(TOS, {
          termsOfServiceUrl,
          privacyPolicyUrl
        })
      })]
...
var WalletSelection = (props) => {
  const modalConfig = (0, import_react10.useContext)(ModalConfigCtx);
  const setModalConfig = (0, import_react10.useContext)(SetModalConfigCtx);
  const walletConfigs = sortWalletConfigs(props.walletConfigs);
  return (0, import_jsx_runtime4.jsx)(WalletList, {
    children: walletConfigs.map((walletConfig) => {
      return (0, import_jsx_runtime4.jsx)("li", {
        "data-full-width": !!walletConfig.selectUI,
        children: walletConfig.selectUI ? (0, import_jsx_runtime4.jsx)(walletConfig.selectUI, {
          ...
          walletConfig
        }) : (0, import_jsx_runtime4.jsx)(WalletEntryButton, {
          walletConfig,
          selectWallet: () => {
            props.selectWallet(walletConfig);
          }
...
function WalletEntryButton(props) {
  ...
  return (0, import_jsx_runtime4.jsxs)(WalletButton, {
    type: "button",
    onClick: () => {
      selectWallet();
    },
    children: [(0, import_jsx_runtime4.jsx)(Img, {
      ...
      }), isRecommended && (0, import_jsx_runtime4.jsx)(Text, {
        size: "sm",
        children: "Recommended"
      }), !isRecommended && walletConfig.isInstalled && walletConfig.isInstalled() && (0, import_jsx_runtime4.jsx)(Text, {
        size: "sm",
        children: "Installed"
      })]
    })]
...
`;
var WalletButton = newStyled.button`
  all: unset;
  display: flex;
  align-items: center;
  gap: ${spacing.sm};
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-NDQSUS4F.js.map
