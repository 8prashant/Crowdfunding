...
// node_modules/@thirdweb-dev/react/dist/magicLink-a4683714.browser.esm.js
init_shim();
...
function magicLink(config) {
  ...
  return {
    ...
    connectUI(props) {
      if (props.modalSize === "wide") {
        return (0, import_jsx_runtime.jsx)(MagicConnectionUIWide, {
          ...props,
          type,
          emailLogin: emailLoginEnabled,
          smsLogin: smsLoginEnabled,
      ...
      return (0, import_jsx_runtime.jsx)(MagicConnectionUICompact, {
        ...props,
        type
      });
    },
...
var MagicUI = (props) => {
  ...
  const socialIconSize = props.modalSize === "compact" ? iconSize.md : iconSize.lg;
        ...
        children: props.oauthProviders.map((provider) => {
          return (0, import_jsx_runtime.jsxs)(SocialButtonLarge, {
            ...
            children: [(0, import_jsx_runtime.jsx)(Img, {
              ...
              children: ["Login with ", upperCaseFirstLetter(provider)]
            })]
          }, provider);
        })
      })
...
var MagicConnectionUICompact = (_ref) => {
  let {
    close,
    walletConfig,
    open,
  ...
  }, [close, connectMagic, open, selectionData, singleWallet, type, walletConfig]);
...
var MagicConnectionUIWide = (props) => {
  const connectMagic = useConnectMagic();
  return (0, import_jsx_runtime.jsxs)(Container, {
    p: "lg",
    fullHeight: true,
...
//# sourceMappingURL=chunk-PLBGMOUN.js.map
