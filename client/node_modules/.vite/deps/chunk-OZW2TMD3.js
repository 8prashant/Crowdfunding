...
// node_modules/@thirdweb-dev/sdk/dist/urls-5c526690.browser.esm.js
init_shim();
function getRpcUrl(network, clientId) {
  return `https://${network}.rpc.thirdweb.com/${clientId || ""}`;
}

// node_modules/@thirdweb-dev/sdk/dist/sdk-33cc295e.browser.esm.js
init_shim();
...
var UserWallet = class {
  ...
  createErc20(currencyAddress) {
    return new ContractWrapper(this.connection.getSignerOrProvider(), currencyAddress, IERC20_default, this.options, this.storage);
  }
};
...
var ContractRegistry = class extends ContractWrapper {
  constructor(registryAddress, network, storage, options) {
    super(network, registryAddress, TWRegistry_default, options, storage);
...
function addChainToSupportedChains(network, options) {
  if (isChainConfig(network)) {
    options = {
      ...options,
      supportedChains: [...(options == null ? void 0 : options.supportedChains) || [], network]
    };
  }
  return options;
}
...
var ContractDeployer = class extends RPCConnectionHandler {
  constructor(network, options, storage) {
    ...
    __publicField(this, "deployLoyaltyCard", buildDeployTransactionFunction(async (metadata, options) => {
      ...
      return await this.deployReleasedContract.prepare(THIRDWEB_DEPLOYER2, "LoyaltyCard", deployArgs, options);
    }));
    __publicField(this, "deployOpenEdition", buildDeployTransactionFunction(async (metadata, options) => {
      ...
      return await this.deployPublishedContract.prepare(THIRDWEB_DEPLOYER2, "OpenEditionERC721", deployArgs, options);
    }));
    ...
    __publicField(this, "deployAirdropERC20", buildDeployTransactionFunction(async (metadata, options) => {
      ...
      return await this.deployReleasedContract.prepare(THIRDWEB_DEPLOYER2, "AirdropERC20", deployArgs, options);
    }));
    __publicField(this, "deployAirdropERC721", buildDeployTransactionFunction(async (metadata, options) => {
      ...
      const signerAddress = await ((_a = this.getSigner()) == null ? void 0 : _a.getAddress());
      const deployArgs = [signerAddress, contractURI, trustedForwarders];
      return await this.deployReleasedContract.prepare(THIRDWEB_DEPLOYER2, "AirdropERC721", deployArgs, options);
    }));
    __publicField(this, "deployAirdropERC1155", buildDeployTransactionFunction(async (metadata, options) => {
      ...
      const signerAddress = await ((_a = this.getSigner()) == null ? void 0 : _a.getAddress());
      const deployArgs = [signerAddress, contractURI, trustedForwarders];
      return await this.deployReleasedContract.prepare(THIRDWEB_DEPLOYER2, "AirdropERC1155", deployArgs, options);
    }));
    ...
    __publicField(this, "deployProxy", buildDeployTransactionFunction(async (implementationAddress, implementationAbi, initializerFunction, initializerArgs) => {
      ...
      const {
        TWProxy__factory
      } = await import("./thirdweb-dev-contracts-js-factories-TWProxy__factory.browser.esm-4FNZXAVB.js");
...
// node_modules/@thirdweb-dev/sdk/dist/abi-008b9fe7.browser.esm.js
init_shim();
init_lib();
...
// node_modules/@thirdweb-dev/sdk/dist/watchTransactions-5ab9ecc7.browser.esm.js
init_shim();
init_lib();
...
//# sourceMappingURL=chunk-OZW2TMD3.js.map
